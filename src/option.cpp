...
static struct {
  ...
  { 'a', ARG_DUP, "<ipaddr>",  gettext_noop("Specify local address(es) to listen on."), nullptr },
  { 'A', ARG_DUP, "/<domain>/<ipaddr>", gettext_noop("Return ipaddr for all hosts in specified domains."), nullptr },
  { 'b', OPT_BOGUSPRIV, nullptr, gettext_noop("Fake reverse lookups for RFC1918 private address ranges."), nullptr },
  { 'B', ARG_DUP, "<ipaddr>", gettext_noop("Treat ipaddr as NXDOMAIN (defeats Verisign wildcard)."), nullptr },
  ...
  { 'd', OPT_DEBUG, nullptr, gettext_noop("Do NOT fork into the background: run in debug mode."), nullptr },
  { 'D', OPT_NODOTS_LOCAL, nullptr, gettext_noop("Do NOT forward queries with no domain part."), nullptr },
  { 'e', OPT_SELFMX, nullptr, gettext_noop("Return self-pointing MX records for local hosts."), nullptr },
  { 'E', OPT_EXPAND, nullptr, gettext_noop("Expand simple names in /etc/hosts with domain-suffix."), nullptr },
  { 'f', OPT_FILTER, nullptr, gettext_noop("Don't forward spurious DNS requests from Windows hosts."), nullptr },
  { 'F', ARG_DUP, "<ipaddr>,...", gettext_noop("Enable DHCP in the range given with lease duration."), nullptr },
  { 'g', ARG_ONE, "<groupname>", gettext_noop("Change to this group after startup (defaults to %s)."), CHGRP },
  { 'G', ARG_DUP, "<hostspec>", gettext_noop("Set address or hostname for a specified machine."), nullptr },
  { LOPT_DHCP_HOST, ARG_DUP, "<path>", gettext_noop("Read DHCP host specs from file."), nullptr },
  { LOPT_DHCP_OPTS, ARG_DUP, "<path>", gettext_noop("Read DHCP option specs from file."), nullptr },
  { LOPT_DHCP_INOTIFY, ARG_DUP, "<path>", gettext_noop("Read DHCP host specs from a directory."), nullptr },
  { LOPT_DHOPT_INOTIFY, ARG_DUP, "<path>", gettext_noop("Read DHCP options from a directory."), nullptr },
  { LOPT_TAG_IF, ARG_DUP, "tag-expression", gettext_noop("Evaluate conditional tag expression."), nullptr },
  { 'h', OPT_NO_HOSTS, nullptr, gettext_noop("Do NOT load %s file."), HOSTSFILE },
  { 'H', ARG_DUP, "<path>", gettext_noop("Specify a hosts file to be read in addition to %s."), HOSTSFILE },
  { LOPT_HOST_INOTIFY, ARG_DUP, "<path>", gettext_noop("Read hosts files from a directory."), nullptr },
  { 'i', ARG_DUP, "<interface>", gettext_noop("Specify interface(s) to listen on."), nullptr },
  { 'I', ARG_DUP, "<interface>", gettext_noop("Specify interface(s) NOT to listen on.") , nullptr },
  { 'j', ARG_DUP, "set:<tag>,<class>", gettext_noop("Map DHCP user class to tag."), nullptr },
  { LOPT_CIRCUIT, ARG_DUP, "set:<tag>,<circuit>", gettext_noop("Map RFC3046 circuit-id to tag."), nullptr },
  { LOPT_REMOTE, ARG_DUP, "set:<tag>,<remote>", gettext_noop("Map RFC3046 remote-id to tag."), nullptr },
  { LOPT_SUBSCR, ARG_DUP, "set:<tag>,<remote>", gettext_noop("Map RFC3993 subscriber-id to tag."), nullptr },
  { 'J', ARG_DUP, "tag:<tag>...", gettext_noop("Don't do DHCP for hosts with tag set."), nullptr },
  { LOPT_BROADCAST, ARG_DUP, "[=tag:<tag>...]", gettext_noop("Force broadcast replies for hosts with tag set."), nullptr },
  { 'k', OPT_NO_FORK, nullptr, gettext_noop("Do NOT fork into the background, do NOT run in debug mode."), nullptr },
  { 'K', OPT_AUTHORITATIVE, nullptr, gettext_noop("Assume we are the only DHCP server on the local network."), nullptr },
  { 'l', ARG_ONE, "<path>", gettext_noop("Specify where to store DHCP leases (defaults to %s)."), LEASEFILE },
  { 'L', OPT_LOCALMX, nullptr, gettext_noop("Return MX records for local hosts."), nullptr },
  { 'm', ARG_DUP, "<host_name>,<target>,<pref>", gettext_noop("Specify an MX record."), nullptr },
  { 'M', ARG_DUP, "<bootp opts>", gettext_noop("Specify BOOTP options to DHCP server."), nullptr },
  { 'n', OPT_NO_POLL, nullptr, gettext_noop("Do NOT poll %s file, reload only on SIGHUP."), RESOLVFILE },
  { 'N', OPT_NO_NEG, nullptr, gettext_noop("Do NOT cache failed search results."), nullptr },
  { 'o', OPT_ORDER, nullptr, gettext_noop("Use nameservers strictly in the order given in %s."), RESOLVFILE },
  { 'O', ARG_DUP, "<optspec>", gettext_noop("Specify options to be sent to DHCP clients."), nullptr },
  { LOPT_FORCE, ARG_DUP, "<optspec>", gettext_noop("DHCP option sent even if the client does not request it."), nullptr},
  { 'p', ARG_ONE, "<integer>", gettext_noop("Specify port to listen for DNS requests on (defaults to 53)."), nullptr },
  { 'P', ARG_ONE, "<integer>", gettext_noop("Maximum supported UDP packet size for EDNS.0 (defaults to %s)."), "*" },
  { 'q', ARG_DUP, nullptr, gettext_noop("Log DNS queries."), nullptr },
  { 'Q', ARG_ONE, "<integer>", gettext_noop("Force the originating port for upstream DNS queries."), nullptr },
  { 'R', OPT_NO_RESOLV, nullptr, gettext_noop("Do NOT read resolv.conf."), nullptr },
  { 'r', ARG_DUP, "<path>", gettext_noop("Specify path to resolv.conf (defaults to %s)."), RESOLVFILE }, 
  { LOPT_SERVERS_FILE, ARG_ONE, "<path>", gettext_noop("Specify path to file with server= options"), nullptr },
  { 'S', ARG_DUP, "/<domain>/<ipaddr>", gettext_noop("Specify address(es) of upstream servers with optional domains."), nullptr },
  { LOPT_REV_SERV, ARG_DUP, "<addr>/<prefix>,<ipaddr>", gettext_noop("Specify address of upstream servers for reverse address queries"), nullptr },
  { LOPT_LOCAL, ARG_DUP, "/<domain>/", gettext_noop("Never forward queries to specified domains."), nullptr },
  { 's', ARG_DUP, "<domain>[,<range>]", gettext_noop("Specify the domain to be assigned in DHCP leases."), nullptr },
  { 't', ARG_ONE, "<host_name>", gettext_noop("Specify default target in an MX record."), nullptr },
  { 'T', ARG_ONE, "<integer>", gettext_noop("Specify time-to-live in seconds for replies from /etc/hosts."), nullptr },
  { LOPT_NEGTTL, ARG_ONE, "<integer>", gettext_noop("Specify time-to-live in seconds for negative caching."), nullptr },
  { LOPT_MAXTTL, ARG_ONE, "<integer>", gettext_noop("Specify time-to-live in seconds for maximum TTL to send to clients."), nullptr },
  { LOPT_MAXCTTL, ARG_ONE, "<integer>", gettext_noop("Specify time-to-live ceiling for cache."), nullptr },
  { LOPT_MINCTTL, ARG_ONE, "<integer>", gettext_noop("Specify time-to-live floor for cache."), nullptr },
  { 'u', ARG_ONE, "<username>", gettext_noop("Change to this user after startup. (defaults to %s)."), CHUSER }, 
  { 'U', ARG_DUP, "set:<tag>,<class>", gettext_noop("Map DHCP vendor class to tag."), nullptr },
  { 'v', 0, nullptr, gettext_noop("Display dnsmasq version and copyright information."), nullptr },
  { 'V', ARG_DUP, "<ipaddr>,<ipaddr>,<netmask>", gettext_noop("Translate IPv4 addresses from upstream servers."), nullptr },
  { 'W', ARG_DUP, "<name>,<target>,...", gettext_noop("Specify a SRV record."), nullptr },
  { 'w', 0, nullptr, gettext_noop("Display this message. Use --help dhcp or --help dhcp6 for known DHCP options."), nullptr },
  ...
  { 'y', OPT_LOCALISE, nullptr, gettext_noop("Answer DNS queries based on the interface a query was sent to."), nullptr },
  { 'Y', ARG_DUP, "<name>,<txt>[,<txt]", gettext_noop("Specify TXT DNS record."), nullptr },
  { LOPT_PTR, ARG_DUP, "<name>,<target>", gettext_noop("Specify PTR DNS record."), nullptr },
  { LOPT_INTNAME, ARG_DUP, "<name>,<interface>", gettext_noop("Give DNS name to IPv4 address of interface."), nullptr },
  { 'z', OPT_NOWILD, nullptr, gettext_noop("Bind only to interfaces in use."), nullptr },
  { 'Z', OPT_ETHERS, nullptr, gettext_noop("Read DHCP static host information from %s."), ETHERSFILE },
  { '1', ARG_ONE, "[=<busname>]", gettext_noop("Enable the DBus interface for setting upstream servers, etc."), nullptr },
  { LOPT_UBUS, OPT_UBUS, nullptr, gettext_noop("Enable the UBus interface."), nullptr },
  { '2', ARG_DUP, "<interface>", gettext_noop("Do not provide DHCP on this interface, only provide DNS."), nullptr },
  { '3', ARG_DUP, "[=tag:<tag>]...", gettext_noop("Enable dynamic address allocation for bootp."), nullptr },
  { '4', ARG_DUP, "set:<tag>,<mac address>", gettext_noop("Map MAC address (with wildcards) to option set."), nullptr },
  { LOPT_BRIDGE, ARG_DUP, "<iface>,<alias>..", gettext_noop("Treat DHCP requests on aliases as arriving from interface."), nullptr },
  { '5', OPT_NO_PING, nullptr, gettext_noop("Disable ICMP echo address checking in the DHCP server."), nullptr },
  { '6', ARG_ONE, "<path>", gettext_noop("Shell script to run on DHCP lease creation and destruction."), nullptr },
  { LOPT_LUASCRIPT, ARG_DUP, "path", gettext_noop("Lua script to run on DHCP lease creation and destruction."), nullptr },
  { LOPT_SCRIPTUSR, ARG_ONE, "<username>", gettext_noop("Run lease-change scripts as this user."), nullptr },
  { LOPT_SCRIPT_ARP, OPT_SCRIPT_ARP, nullptr, gettext_noop("Call dhcp-script with changes to local ARP table."), nullptr },
  { '7', ARG_DUP, "<path>", gettext_noop("Read configuration from all the files in this directory."), nullptr },
  { '8', ARG_ONE, "<facility>|<file>", gettext_noop("Log to this syslog facility or file. (defaults to DAEMON)"), nullptr },
  { '9', OPT_LEASE_RO, nullptr, gettext_noop("Do not use leasefile."), nullptr },
  { '0', ARG_ONE, "<integer>", gettext_noop("Maximum number of concurrent DNS queries. (defaults to %s)"), "!" }, 
  { LOPT_RELOAD, OPT_RELOAD, nullptr, gettext_noop("Clear DNS cache when reloading %s."), RESOLVFILE },
  { LOPT_NO_NAMES, ARG_DUP, "[=tag:<tag>]...", gettext_noop("Ignore hostnames provided by DHCP clients."), nullptr },
  { LOPT_OVERRIDE, OPT_NO_OVERRIDE, nullptr, gettext_noop("Do NOT reuse filename and server fields for extra DHCP options."), nullptr },
  { LOPT_TFTP, ARG_DUP, "[=<intr>[,<intr>]]", gettext_noop("Enable integrated read-only TFTP server."), nullptr },
  { LOPT_PREFIX, ARG_DUP, "<dir>[,<iface>]", gettext_noop("Export files by TFTP only from the specified subtree."), nullptr },
  { LOPT_APREF, ARG_DUP, "[=ip|mac]", gettext_noop("Add client IP or hardware address to tftp-root."), nullptr },
  { LOPT_SECURE, OPT_TFTP_SECURE, nullptr, gettext_noop("Allow access only to files owned by the user running dnsmasq."), nullptr },
  { LOPT_TFTP_NO_FAIL, OPT_TFTP_NO_FAIL, nullptr, gettext_noop("Do not terminate the service if TFTP directories are inaccessible."), nullptr },
  { LOPT_TFTP_MAX, ARG_ONE, "<integer>", gettext_noop("Maximum number of concurrent TFTP transfers (defaults to %s)."), "#" },
  { LOPT_TFTP_MTU, ARG_ONE, "<integer>", gettext_noop("Maximum MTU to use for TFTP transfers."), nullptr },
  { LOPT_NOBLOCK, OPT_TFTP_NOBLOCK, nullptr, gettext_noop("Disable the TFTP blocksize extension."), nullptr },
  { LOPT_TFTP_LC, OPT_TFTP_LC, nullptr, gettext_noop("Convert TFTP filenames to lowercase"), nullptr },
  { LOPT_TFTPPORTS, ARG_ONE, "<start>,<end>", gettext_noop("Ephemeral port range for use by TFTP transfers."), nullptr },
  { LOPT_LOG_OPTS, OPT_LOG_OPTS, nullptr, gettext_noop("Extra logging for DHCP."), nullptr },
  { LOPT_MAX_LOGS, ARG_ONE, "[=<integer>]", gettext_noop("Enable async. logging; optionally set queue length."), nullptr },
  { LOPT_REBIND, OPT_NO_REBIND, nullptr, gettext_noop("Stop DNS rebinding. Filter private IP ranges when resolving."), nullptr },
  { LOPT_LOC_REBND, OPT_LOCAL_REBIND, nullptr, gettext_noop("Allow rebinding of 127.0.0.0/8, for RBL servers."), nullptr },
  { LOPT_NO_REBIND, ARG_DUP, "/<domain>/", gettext_noop("Inhibit DNS-rebind protection on this domain."), nullptr },
  { LOPT_NOLAST, OPT_ALL_SERVERS, nullptr, gettext_noop("Always perform DNS queries to all servers."), nullptr },
  { LOPT_MATCH, ARG_DUP, "set:<tag>,<optspec>", gettext_noop("Set tag if client includes matching option in request."), nullptr },
  { LOPT_NAME_MATCH, ARG_DUP, "set:<tag>,<string>[*]", gettext_noop("Set tag if client provides given name."), nullptr },
  { LOPT_ALTPORT, ARG_ONE, "[=<ports>]", gettext_noop("Use alternative ports for DHCP."), nullptr },
  { LOPT_NAPTR, ARG_DUP, "<name>,<naptr>", gettext_noop("Specify NAPTR DNS record."), nullptr },
  { LOPT_MINPORT, ARG_ONE, "<port>", gettext_noop("Specify lowest port available for DNS query transmission."), nullptr },
  { LOPT_MAXPORT, ARG_ONE, "<port>", gettext_noop("Specify highest port available for DNS query transmission."), nullptr },
  { LOPT_DHCP_FQDN, OPT_DHCP_FQDN, nullptr, gettext_noop("Use only fully qualified domain names for DHCP clients."), nullptr },
  { LOPT_GEN_NAMES, ARG_DUP, "[=tag:<tag>]", gettext_noop("Generate hostnames based on MAC address for nameless clients."), nullptr},
  { LOPT_PROXY, ARG_DUP, "[=<ipaddr>]...", gettext_noop("Use these DHCP relays as full proxies."), nullptr },
  { LOPT_RELAY, ARG_DUP, "<local-addr>,<server>[,<iface>]", gettext_noop("Relay DHCP requests to a remote server"), nullptr},
  { LOPT_CNAME, ARG_DUP, "<alias>,<target>[,<ttl>]", gettext_noop("Specify alias name for LOCAL DNS name."), nullptr },
  { LOPT_PXE_PROMT, ARG_DUP, "<prompt>,[<timeout>]", gettext_noop("Prompt to send to PXE clients."), nullptr },
  { LOPT_PXE_SERV, ARG_DUP, "<service>", gettext_noop("Boot service for PXE menu."), nullptr },
  { LOPT_TEST, 0, nullptr, gettext_noop("Check configuration syntax."), nullptr },
  { LOPT_ADD_MAC, ARG_DUP, "[=base64|text]", gettext_noop("Add requestor's MAC address to forwarded DNS queries."), nullptr },
  { LOPT_ADD_SBNET, ARG_ONE, "<v4 pref>[,<v6 pref>]", gettext_noop("Add specified IP subnet to forwarded DNS queries."), nullptr },
  { LOPT_CPE_ID, ARG_ONE, "<text>", gettext_noop("Add client identification to forwarded DNS queries."), nullptr },
  { LOPT_DNSSEC, OPT_DNSSEC_PROXY, nullptr, gettext_noop("Proxy DNSSEC validation results from upstream nameservers."), nullptr },
  { LOPT_INCR_ADDR, OPT_CONSEC_ADDR, nullptr, gettext_noop("Attempt to allocate sequential IP addresses to DHCP clients."), nullptr },
  { LOPT_CONNTRACK, OPT_CONNTRACK, nullptr, gettext_noop("Copy connection-track mark from queries to upstream connections."), nullptr },
  { LOPT_FQDN, OPT_FQDN_UPDATE, nullptr, gettext_noop("Allow DHCP clients to do their own DDNS updates."), nullptr },
  { LOPT_RA, OPT_RA, nullptr, gettext_noop("Send router-advertisements for interfaces doing DHCPv6"), nullptr },
  { LOPT_DUID, ARG_ONE, "<enterprise>,<duid>", gettext_noop("Specify DUID_EN-type DHCPv6 server DUID"), nullptr },
  { LOPT_HOST_REC, ARG_DUP, "<name>,<address>[,<ttl>]", gettext_noop("Specify host (A/AAAA and PTR) records"), nullptr },
  { LOPT_CAA, ARG_DUP, "<name>,<flags>,<tag>,<value>", gettext_noop("Specify certification authority authorization record"), nullptr },
  { LOPT_RR, ARG_DUP, "<name>,<RR-number>,[<data>]", gettext_noop("Specify arbitrary DNS resource record"), nullptr },
  { LOPT_CLVERBIND, OPT_CLEVERBIND, nullptr, gettext_noop("Bind to interfaces in use - check for new interfaces"), nullptr },
  { LOPT_AUTHSERV, ARG_ONE, "<NS>,<interface>", gettext_noop("Export local names to global DNS"), nullptr },
  { LOPT_AUTHZONE, ARG_DUP, "<domain>,[<subnet>...]", gettext_noop("Domain to export to global DNS"), nullptr },
  { LOPT_AUTHTTL, ARG_ONE, "<integer>", gettext_noop("Set TTL for authoritative replies"), nullptr },
  { LOPT_AUTHSOA, ARG_ONE, "<serial>[,...]", gettext_noop("Set authoritative zone information"), nullptr },
  { LOPT_AUTHSFS, ARG_DUP, "<NS>[,<NS>...]", gettext_noop("Secondary authoritative nameservers for forward domains"), nullptr },
  { LOPT_AUTHPEER, ARG_DUP, "<ipaddr>[,<ipaddr>...]", gettext_noop("Peers which are allowed to do zone transfer"), nullptr },
  { LOPT_IPSET, ARG_DUP, "/<domain>[/<domain>...]/<ipset>...", gettext_noop("Specify ipsets to which matching domains should be added"), nullptr },
  { LOPT_SYNTH, ARG_DUP, "<domain>,<range>,[<prefix>]", gettext_noop("Specify a domain and address range for synthesised names"), nullptr },
  { LOPT_SEC_VALID, OPT_DNSSEC_VALID, nullptr, gettext_noop("Activate DNSSEC validation"), nullptr },
  { LOPT_TRUST_ANCHOR, ARG_DUP, "<domain>,[<class>],...", gettext_noop("Specify trust anchor key digest."), nullptr },
  { LOPT_DNSSEC_DEBUG, OPT_DNSSEC_DEBUG, nullptr, gettext_noop("Disable upstream checking for DNSSEC debugging."), nullptr },
  { LOPT_DNSSEC_CHECK, ARG_DUP, nullptr, gettext_noop("Ensure answers without DNSSEC are in unsigned zones."), nullptr },
  { LOPT_DNSSEC_TIME, OPT_DNSSEC_TIME, nullptr, gettext_noop("Don't check DNSSEC signature timestamps until first cache-reload"), nullptr },
  { LOPT_DNSSEC_STAMP, ARG_ONE, "<path>", gettext_noop("Timestamp file to verify system clock for DNSSEC"), nullptr },
#ifdef OPTION6_PREFIX_CLASS 
  { LOPT_PREF_CLSS, ARG_DUP, "set:tag,<class>", gettext_noop("Specify DHCPv6 prefix class"), nullptr },
#endif
  { LOPT_RA_PARAM, ARG_DUP, "<iface>,[mtu:<value>|<interface>|off,][<prio>,]<intval>[,<lifetime>]", gettext_noop("Set MTU, priority, resend-interval and router-lifetime"), nullptr },
  { LOPT_QUIET_DHCP, OPT_QUIET_DHCP, nullptr, gettext_noop("Do not log routine DHCP."), nullptr },
  { LOPT_QUIET_DHCP6, OPT_QUIET_DHCP6, nullptr, gettext_noop("Do not log routine DHCPv6."), nullptr },
  { LOPT_QUIET_RA, OPT_QUIET_RA, nullptr, gettext_noop("Do not log RA."), nullptr },
  { LOPT_LOCAL_SERVICE, OPT_LOCAL_SERVICE, nullptr, gettext_noop("Accept queries only from directly-connected networks."), nullptr },
  { LOPT_LOOP_DETECT, OPT_LOOP_DETECT, nullptr, gettext_noop("Detect and remove DNS forwarding loops."), nullptr },
  { LOPT_IGNORE_ADDR, ARG_DUP, "<ipaddr>", gettext_noop("Ignore DNS responses containing ipaddr."), nullptr },
  { LOPT_DHCPTTL, ARG_ONE, "<ttl>", gettext_noop("Set TTL in DNS responses with DHCP-derived addresses."), nullptr },
  { LOPT_REPLY_DELAY, ARG_ONE, "<integer>", gettext_noop("Delay DHCP replies for at least number of seconds."), nullptr },
  { LOPT_RAPID_COMMIT, OPT_RAPID_COMMIT, nullptr, gettext_noop("Enables DHCPv4 Rapid Commit option."), nullptr },
  { LOPT_DUMPFILE, ARG_ONE, "<path>", gettext_noop("Path to debug packet dump file"), nullptr },
  { LOPT_DUMPMASK, ARG_ONE, "<hex>", gettext_noop("Mask which packets to dump"), nullptr },
...
static char *canonicalise_opt(char *s)
{
  ...
  if (!(ret = canonicalise(s, &nomem)) && nomem)
	...
	die(_("could not get memory"), nullptr, EC_NOMEM);
    }
...
static int parse_dhcp_opt(char *errstr, char *arg, int flags)
{
  ...
  if (comma)
      ...
      else if (is_hex && digs > 1)
	{
	  ...
	  parse_hex(comma, new->val, digs, (flags & DHOPT_MATCH) ? &new->u.wildcard_mask : nullptr, nullptr);
	  new->flags |= DHOPT_HEX;
	}
      else if (is_dec)
	{
      ...
      else if (is_string)
	{
	  ...
	  if ((new->opt == OPTION_DOMAIN_SEARCH || new->opt == OPTION_SIP_SERVER) &&
	      !is6 && !(new->flags & (DHOPT_ENCAPSULATE | DHOPT_VENDOR | DHOPT_RFC3925)))
	    {
	      ...
	      unsigned char *p, *m = nullptr, *newp;
	      size_t newlen, len = 0;
	    ...
	    {
	      unsigned char *p = nullptr, *newp, *end;
	      int len = 0;
	      arg = comma;
	      comma = split(arg);
	      ...
	      while (arg && *arg)
		{
		  ...
		  p = newp;
		  end = do_rfc1035_name(p + len, dom, nullptr);
		  *end++ = 0;
		  len = end - p;
		  free(dom);
...
{      
  ...
  switch (option)
	...
	struct list {
	  char *suffix;
	  struct list *next;
	} *ignore_suffix = nullptr, *match_suffix = nullptr, *li;
    ...
    case LOPT_DUMPMASK:  /* --dumpmask */
      daemon->dump_mask = strtol(arg, nullptr, 0);
      break;
...
#  endif
    ...
    case LOPT_NO_REBIND: /*  --rebind-domain-ok */
      {
	struct server *serv, *newlist = nullptr;
    ...
    case LOPT_PREFIX: /* --tftp-prefix */
      ...
      if (comma)
	{
	  struct tftp_prefix *new = opt_malloc(sizeof(struct TftpPrefix));
    ...
    case 'G':  /* --dhcp-host */
      {
	int j, k = 0;
	char *a[7] = { nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr };
		  ...
		  arg[2] == ':')
		{
		  if (arg[3] == '*')
		  ...
		  else
		    {
		      ...
		      arg += 3; /* dump id: */
		      if (strchr(arg, ':'))
			len = parse_hex(arg, (unsigned char *)arg, -1, nullptr, nullptr);
		      else
			{
			  unhide_metas(arg);
			  len = (int) strlen(arg);
	...
	if (!arg)
	  ...
	  {
	    char *dhcp_file, *dhcp_sname = nullptr, *tftp_sname = nullptr;
    ...
    case LOPT_SUBSCR:   /* --dhcp-subscrid */
	 ...
	 if (option == 'U' || option == 'j' || *p || !dig)
	   ...
	   {
	     new->len = parse_hex(comma, (unsigned char *)comma, strlen(comma), nullptr, nullptr);
	     new->data = opt_malloc(new->len);
	     memcpy(new->data, comma, new->len);
	   }
	...
	struct dhcp_netid *list = nullptr;
	if (option == 'J')
	  {
    ...
    case LOPT_PROXY: /* --dhcp-proxy */
      daemon->override = 1;
      while (arg) {
	struct addr_list *new = opt_malloc(sizeof(struct AddrList));
	comma = split(arg);
    ...
    case LOPT_RELAY: /* --dhcp-relay */
      {
	struct dhcp_relay *new = opt_malloc(sizeof(struct DhcpRelay));
	comma = split(arg);
...
err:
	...
	{
	  daemon->duid_config_len = parse_hex(comma,(unsigned char *)comma, strlen(comma), nullptr, nullptr);
    ...
    case 'V':  /* --alias */
      {
	char *dash, *a[3] = { nullptr, nullptr, nullptr };
	int k = 0;
	...
	*up = new;
	...
	for (last = pen = nullptr, comma = arg; comma; comma = split(comma))
	  {
	    pen = last;
	    last = comma;
	  }
	...
	if (!atoi_check(comma, &val) || 
	    ...
	    (data && (len = parse_hex(data, (unsigned char *)data, -1, nullptr, nullptr)) == -1U))
	...
	*cnt = 0;
	...
	struct ds_config *new = opt_malloc(sizeof(struct ds_config));
      	char *cp, *cp1, *keyhex, *digest, *algo = nullptr;
	int len;
	...
	for (cp = keyhex; *cp; )
	  if (isspace(*cp))
	    ...
	    cp++;
	if ((new->digestlen = parse_hex(keyhex, (unsigned char *)new->digest, len, nullptr, nullptr)) == -1)
...
#  ifdef HAVE_INOTIFY
  ...
  set_dynamic_inotify(AH_DHCP_HST | AH_DHCP_OPT, 0, nullptr, 0);
#  endif
}
#endif
...
void read_opts(int argc, char **argv, char *compile_opts)
{
  ...
  add_txt("cachesize.bind", nullptr, TXT_STAT_CACHESIZE);
  add_txt("insertions.bind", nullptr, TXT_STAT_INSERTS);
  add_txt("evictions.bind", nullptr, TXT_STAT_EVICTIONS);
  add_txt("misses.bind", nullptr, TXT_STAT_MISSES);
  add_txt("hits.bind", nullptr, TXT_STAT_HITS);
#ifdef HAVE_AUTH
  add_txt("auth.bind", nullptr, TXT_STAT_AUTH);
#endif
  add_txt("servers.bind", nullptr, TXT_STAT_SERVERS);
#endif

  while (1) 
    {
#ifdef HAVE_GETOPT_LONG
      option = getopt_long(argc, argv, OPTSTRING, opts, nullptr);
#else
	  ...
	  for (; optind < argc; optind++)
	    {
	      ...
	      for (; *c != 0; c++)
		if (!isspace(*c))
		  die(_("junk found in command line"), nullptr, EC_BADCONF);
	    }
	  break;
	}
...
#define TESTLOOP 2      
  ...
  if (option_bool(OPT_LOCALMX) || daemon->mxnames || daemon->mxtarget)
	...
	die(_("cannot get host-name: %s"), nullptr, EC_MISC);
  ...
  if (!option_bool(OPT_NO_RESOLV) &&
    ...
    die(_("only one resolv.conf file allowed in no-poll mode."), nullptr, EC_BADCONF);
  ...
  if (option_bool(OPT_RESOLV_DOMAIN))
    {
	  ...
	  !daemon->resolv_files || 
	  (daemon->resolv_files)->next)
	die(_("must have exactly one resolv.conf to read domain from."), nullptr, EC_BADCONF);
  ...
  if (daemon->domain_suffix)
    ...
    die(_("there must be a default domain when --dhcp-fqdn is set"), nullptr, EC_BADCONF);
