...
pub mod socket_h {
    ...
    #[c2rust::src_loc = "94:9"]
    pub const AF_UNIX: libc::c_int = PF_UNIX;
...
pub mod dnsmasq_h {
    ...
    pub const EVENT_LOG_ERR: libc::c_int = 17 as libc::c_int;
    ...
    use super::syslog_h::{LOG_MAIL, LOG_DAEMON, LOG_USER};
    extern "C" {
        #[no_mangle]
...
pub mod syslog_h {
    ...
    pub const LOG_PID: libc::c_int = 0x1 as libc::c_int;
    #[c2rust::src_loc = "60:9"]
    pub const LOG_PRIMASK: libc::c_int = 0x7 as libc::c_int;
    #[c2rust::src_loc = "95:9"]
    pub const LOG_MAIL: libc::c_int = (2 as libc::c_int) << 3 as libc::c_int;
    #[c2rust::src_loc = "117:9"]
    pub const LOG_FACMASK: libc::c_int = 0x3f8 as libc::c_int;
    #[c2rust::src_loc = "94:9"]
...
pub mod asm_generic_errno_h {
    #[c2rust::src_loc = "74:9"]
    pub const EPROTOTYPE: libc::c_int = 91 as libc::c_int;
    #[c2rust::src_loc = "22:9"]
    pub const EWOULDBLOCK: libc::c_int = EAGAIN;
    #[c2rust::src_loc = "89:9"]
    pub const EISCONN: libc::c_int = 106 as libc::c_int;
    #[c2rust::src_loc = "94:9"]
    pub const ECONNREFUSED: libc::c_int = 111 as libc::c_int;
    #[c2rust::src_loc = "97:9"]
    pub const EALREADY: libc::c_int = 114 as libc::c_int;
    #[c2rust::src_loc = "87:9"]
    pub const ECONNRESET: libc::c_int = 104 as libc::c_int;
    #[c2rust::src_loc = "72:9"]
    pub const EDESTADDRREQ: libc::c_int = 89 as libc::c_int;
    #[c2rust::src_loc = "90:9"]
    pub const ENOTCONN: libc::c_int = 107 as libc::c_int;
    #[c2rust::src_loc = "88:9"]
...
#[c2rust::header_src = "/usr/include/x86_64-linux-gnu/bits/syslog-path.h:17"]
pub mod syslog_path_h {
    #[c2rust::src_loc = "26:9"]
    pub const _PATH_LOG: [libc::c_char; 9] =
        unsafe {
            *::std::mem::transmute::<&[u8; 9],
                                     &[libc::c_char; 9]>(b"/dev/log\x00")
        };
}
...
pub use self::dnsmasq_h::{u32_0, all_addr, C2RustUnnamed_0, C2RustUnnamed_1,
                          ...
                          dhcp_relay, dnsmasq_daemon, MS_SCRIPT, MS_DHCP,
                          MS_TFTP, EVENT_LOG_ERR, safe_malloc, safe_strncpy,
                          send_event, poll_listen, poll_check};
...
use self::stdio_h::{stdin, stdout, stderr, fprintf, sprintf, vfprintf,
                    vsnprintf, getc, fputc, putc, __getdelim, __uflow,
                    __overflow};
pub use self::sys_stat_h::{stat, fstat, stat64, fstat64, fstatat, fstatat64,
                           ...
                           __xmknod, __xmknodat};
use self::string_h::{strcmp, strerror};
pub use self::unistd_h::{STDERR_FILENO, close, write, fchown, dup, _exit,
                         getpid};
...
pub use self::fcntl_h::{S_IRUSR, S_IRGRP, S_IWUSR, fcntl, open};
pub use self::ctype_h::{tolower, toupper, __ctype_tolower_loc,
                        __ctype_toupper_loc};
use self::time_h::{time, ctime, nanosleep};
pub use self::errno_h::{errno, __errno_location};
pub use self::syslog_h::{LOG_CRIT, LOG_DAEMON, LOG_PID, LOG_PRIMASK, LOG_MAIL,
                         LOG_FACMASK, LOG_USER, LOG_WARNING, LOG_LOCAL0,
                         openlog, vsyslog};
pub use self::fcntl_linux_h::{O_NONBLOCK, F_SETFL, F_GETFL, O_APPEND, O_CREAT,
                              O_WRONLY};
pub use self::asm_generic_errno_h::{EPROTOTYPE, EWOULDBLOCK, EISCONN,
                                    ECONNREFUSED, EALREADY, ECONNRESET,
                                    EDESTADDRREQ, ENOTCONN, ENOBUFS};
pub use self::errno_base_h::{EAGAIN, EINTR, ENOENT, EPIPE};
pub use self::syslog_path_h::_PATH_LOG;
pub use self::poll_h::POLLOUT;
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "47:8"]
...
/* From RFC 3164 */
#[c2rust::src_loc = "33:9"]
pub const MAX_MESSAGE: libc::c_int = 1024 as libc::c_int;
/* defaults in case we die() before we log_start() */
#[c2rust::src_loc = "36:12"]
static mut log_fac: libc::c_int = LOG_DAEMON;
...
#[c2rust::src_loc = "43:12"]
static mut connection_good: libc::c_int = 1 as libc::c_int;
#[c2rust::src_loc = "44:12"]
static mut max_logs: libc::c_int = 0 as libc::c_int;
#[c2rust::src_loc = "45:12"]
static mut connection_type: libc::c_int = SOCK_DGRAM_0;
#[c2rust::src_loc = "54:26"]
static mut entries: *mut log_entry = NULL_0 as *mut log_entry;
#[c2rust::src_loc = "55:26"]
static mut free_entries: *mut log_entry = NULL_0 as *mut log_entry;
#[no_mangle]
#[c2rust::src_loc = "58:1"]
    ...
    if max_logs == 0 as libc::c_int {
        free_entries =
            safe_malloc(::std::mem::size_of::<log_entry>() as libc::c_ulong)
                as *mut log_entry;
        (*free_entries).next = NULL_0 as *mut log_entry;
 ...
 -> libc::c_int {
    if log_stderr == 0 {
        ...
        if !log_file.is_null() {
            ...
            log_fd = socket(AF_UNIX, connection_type, 0 as libc::c_int);
            /* if max_logs is zero, leave the socket blocking */
            if log_fd != -(1 as libc::c_int) && max_logs != 0 as libc::c_int
                   &&
                   {
                       flags = fcntl(log_fd, F_GETFL);
...
unsafe extern "C" fn log_write() {
    ...
    while !entries.is_null() {
	 ...
	 a newline, and leave the length alone. */
        let mut len_adjust = 0 as libc::c_int;
        if log_to_file != 0 {
            (*entries).payload[((*entries).offset + (*entries).length -
                                    1 as libc::c_int) as usize] =
                '\n' as i32 as libc::c_char
        } else if connection_type == SOCK_DGRAM_0 {
        ...
        if (*entries).pid != getpid() {
	     ...
	     (we ignore SIGPIPE) */
                    if errno == EPIPE {
                        if log_reopen(NULL_0 as *mut libc::c_char) != 0 {
                            continue ;
                        }
		 ...
		 (ECONNRESET, EDESTADDRREQ are *BSD equivalents) */
                        ...
                        logaddr.sun_family = AF_UNIX as sa_family_t;
                        ...
                        if errno == ENOENT || errno == EALREADY ||
                               errno == ECONNREFUSED || errno == EISCONN ||
                        ...
                        if errno == EPROTOTYPE {
                            connection_type =
                                if connection_type == SOCK_DGRAM_0 {
                                    SOCK_STREAM_0
                                } else { SOCK_DGRAM_0 };
                            if log_reopen(NULL_0 as *mut libc::c_char) != 0 {
                                continue ;
...
pub unsafe extern "C" fn my_syslog(mut priority: libc::c_int,
    ...
    let mut entry = 0 as *mut log_entry;
    ...
    if entry.is_null() {
        ...
        (*entry).next = NULL_0 as *mut log_entry;
        if entries.is_null() {
            entries = entry
        } else {
            let mut tmp = 0 as *mut log_entry;
            tmp = entries;
        ...
        len =
            (len as
                ...
                size_t;
        (*entry).length =
            if len > MAX_MESSAGE as libc::c_ulong {
                MAX_MESSAGE as libc::c_ulong
...
pub unsafe extern "C" fn set_log_writer() {
    if !entries.is_null() && log_fd != -(1 as libc::c_int) &&
           connection_good != 0 {
        poll_listen(log_fd, POLLOUT as libc::c_short);
    };
}
#[no_mangle]
#[c2rust::src_loc = "432:1"]
pub unsafe extern "C" fn check_log_writer(mut force: libc::c_int) {
    if log_fd != -(1 as libc::c_int) &&
           (force != 0 || poll_check(log_fd, POLLOUT as libc::c_short) != 0) {
        log_write();
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn flush_log() {
   ...
   no connection to the syslog in existence */
    while log_fd != -(1 as libc::c_int) {
        let mut waiter = timespec{tv_sec: 0, tv_nsec: 0,}; /* 1 ms */
...
pub unsafe extern "C" fn die(mut message: *mut libc::c_char,
    ...
    let mut errmess = strerror(errno);
