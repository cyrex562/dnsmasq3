...
pub const MAX_PROCS: usize = 20; /* max no children for TCP requests */
...
pub const RANDOM_SOCKS: usize = 64; /* max simultaneous random ports */
...
pub const DECLINE_BACKOFF: u32 = 600; /* disable DECLINEd  addresses for this long */
...
HAVE_BROKEN_RTC
   ...
   up-to-date: rewriting it after every renewal.  When
   ...
   define this to get dnsmasq's DHCPv6 server. (implies ).
...
/* Build options which require external libraries.
   ...
   Defining HAVE_<opt>_ as _well_ as HAVE_<opt> will link the library ally.
...
// pub const MAX_PROCS: u32 = 0xffff;
