...
pub mod dnsmasq_h {
    ...
    #[c2rust::src_loc = "615:9"]
    pub const AH_WD_DONE: libc::c_int = 4 as libc::c_int;
    ...
    extern "C" {
        ...
        pub fn read_hostsfile(filename: *mut libc::c_char,
                              index: libc::c_uint, cache_size: libc::c_int,
                              rhash: *mut *mut crec, hashsz: libc::c_int)
         -> libc::c_int;
        #[no_mangle]
        ...
        pub fn option_read_dynfile(file: *mut libc::c_char,
...
#[c2rust::header_src = "/usr/include/x86_64-linux-gnu/bits/dirent.h:17"]
pub mod dirent_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "22:8"]
...
#[c2rust::header_src = "/usr/include/dirent.h:17"]
...
#[c2rust::header_src = "/usr/include/x86_64-linux-gnu/bits/inotify.h:20"]
pub mod inotify_h {
    #[c2rust::src_loc = "25:5"]
    ...
    #[c2rust::src_loc = "26:9"]
    pub const IN_CLOEXEC_0: libc::c_int = IN_CLOEXEC as libc::c_int;
    #[c2rust::src_loc = "28:9"]
    pub const IN_NONBLOCK_0: libc::c_int = IN_NONBLOCK as libc::c_int;
}
#[c2rust::header_src = "/usr/include/x86_64-linux-gnu/sys/inotify.h:20"]
pub mod sys_inotify_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "28:8"]
    ...
    #[c2rust::src_loc = "42:9"]
    pub const IN_CLOSE_WRITE: libc::c_int = 0x8 as libc::c_int;
    #[c2rust::src_loc = "47:9"]
    pub const IN_MOVED_TO: libc::c_int = 0x80 as libc::c_int;
    use super::stdint_uintn_h::uint32_t;
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "88:1"]
        pub fn inotify_init1(__flags: libc::c_int) -> libc::c_int;
        #[no_mangle]
        #[c2rust::src_loc = "92:1"]
        pub fn inotify_add_watch(__fd: libc::c_int,
...
#[c2rust::header_src = "/usr/include/linux/limits.h:17"]
pub mod limits_h {
    #[c2rust::src_loc = "12:9"]
    pub const NAME_MAX: libc::c_int = 255 as libc::c_int;
}
...
#[c2rust::header_src = "/usr/include/x86_64-linux-gnu/bits/param.h:21"]
pub mod param_h {
    #[c2rust::src_loc = "36:9"]
    pub const MAXSYMLINKS: libc::c_int = 20 as libc::c_int;
}
...
pub use self::dnsmasq_h::{u32_0, all_addr, C2RustUnnamed_0, C2RustUnnamed_1,
                          ...
                          dhcp_relay, dnsmasq_daemon, AH_WD_DONE, AH_HOSTS,
                          AH_DHCP_HST, AH_DHCP_OPT, EC_MISC,
                          dhcp_update_configs, lease_update_from_configs,
                          read_hostsfile, safe_malloc, whine_malloc, die,
                          my_syslog, option_read_dynfile, lease_update_file,
                          lease_update_dns};
...
pub use self::include_dirent_h::{DIR, __dirstream, opendir, closedir,
                                 readdir};
pub use self::inotify_h::{IN_CLOEXEC, IN_NONBLOCK, C2RustUnnamed_8,
                          IN_CLOEXEC_0, IN_NONBLOCK_0};
pub use self::sys_inotify_h::{inotify_event, IN_CLOSE_WRITE, IN_MOVED_TO,
...
pub use self::sys_stat_h::{stat, fstat, stat64, fstat64, fstatat, fstatat64,
                           ...
                           __xmknod, __xmknodat};
use self::string_h::{strcpy, strcat, strcmp, strrchr, strlen, strerror};
use self::unistd_h::{read, readlink};
...
pub use self::syslog_h::{LOG_ERR, LOG_INFO};
pub use self::errno_base_h::{EINTR, EINVAL, ENOENT};
pub use self::limits_h::NAME_MAX;
...
pub use self::ctype_h::{tolower, toupper, __ctype_tolower_loc,
                        __ctype_toupper_loc};
pub use self::param_h::MAXSYMLINKS;
...
unsafe extern "C" fn my_readlink(mut path: *mut libc::c_char)
 -> *mut libc::c_char {
    ...
    let mut size = 64 as libc::c_int as ssize_t;
...
pub unsafe extern "C" fn inotify_dnsmasq_init() {
    ...
    inotify_buffer =
        safe_malloc((::std::mem::size_of::<inotify_event>() as
                         libc::c_ulong).wrapping_add(NAME_MAX as
                                                         libc::c_ulong).wrapping_add(1
                                                                                         ...
                                                                                         libc::c_ulong))
            as *mut libc::c_char;
    (*dnsmasq_daemon).inotifyfd = inotify_init1(IN_NONBLOCK_0 | IN_CLOEXEC_0);
    ...
    while !res.is_null() {
        let mut d = 0 as *mut libc::c_char;
        let mut new_path = 0 as *mut libc::c_char;
        let mut path =
...
pub unsafe extern "C" fn set_dynamic_inotify(mut flag: libc::c_int,
    ...
    while !ah.is_null() {
        let mut dir_stream = NULL_0 as *mut DIR;
        ...
        if !((*ah).flags & flag == 0) {
            if stat((*ah).fname, &mut buf) == -(1 as libc::c_int) ||
                ...
                if (*ah).flags & AH_WD_DONE == 0 {
                    (*ah).wd =
                        inotify_add_watch((*dnsmasq_daemon).inotifyfd,
                                          (*ah).fname,
                                          (IN_CLOSE_WRITE | IN_MOVED_TO) as
                                              uint32_t);
                    (*ah).flags |= AH_WD_DONE
                }
                    ...
                    loop  {
                        ...
                        if !path.is_null() {
                            ...
                            if stat(path, &mut buf) != -(1 as libc::c_int) &&
                               ...
                               {
                                if (*ah).flags & AH_HOSTS != 0 {
                                    total_size =
                                        read_hostsfile(path, (*ah).index,
                                                       total_size, rhash,
                                                       revhashsz)
                                } else if (*ah).flags &
                                              (AH_DHCP_HST | AH_DHCP_OPT) != 0
                                 {
...
pub unsafe extern "C" fn inotify_check(mut now: time_t) -> libc::c_int {
    let mut hit = 0 as libc::c_int;
    let mut ah = 0 as *mut hostsfile;
    loop  {
        let mut rc: libc::c_int = 0;
        let mut p = 0 as *mut libc::c_char;
        let mut res = 0 as *mut resolvc;
        let mut in_0 = 0 as *mut inotify_event;
        loop  {
            rc =
                     ...
                     (::std::mem::size_of::<inotify_event>() as
                          libc::c_ulong).wrapping_add(NAME_MAX as
                                                          libc::c_ulong).wrapping_add(1
                                                                                          ...
                                                                                          libc::c_ulong))
                    as libc::c_int;
            if !(rc == -(1 as libc::c_int) && errno == EINTR) { break ; }
        }
                ...
                while !ah.is_null() {
                    if (*ah).wd == (*in_0).wd {
                        ...
                        if !path.is_null() {
                            ...
                            } else if (*ah).flags & AH_DHCP_HST != 0 {
                                if option_read_dynfile(path, AH_DHCP_HST) != 0
                                   {
                                    /* Propagate the consequences of loading a new dhcp-host */
                                    dhcp_update_configs((*dnsmasq_daemon).dhcp_conf);
                                    lease_update_from_configs();
                            ...
                            } else if (*ah).flags & AH_DHCP_OPT != 0 {
