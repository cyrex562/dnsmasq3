...
pub mod in_h {
    ...
    #[c2rust::src_loc = "91:9"]
    pub const IPPROTO_RAW_0: libc::c_int = IPPROTO_RAW as libc::c_int;
    use super::sockaddr_h::sa_family_t;
...
#[c2rust::header_src = "/usr/include/linux/types.h:17"]
pub mod linux_types_h {
    #[c2rust::src_loc = "25:1"]
    pub type __be16 = __u16;
    use super::int_ll64_h::__u16;
}
#[c2rust::header_src =
...
pub mod netlink_h {
    ...
    #[c2rust::src_loc = "21:9"]
    pub const NETLINK_NETFILTER: libc::c_int = 12 as libc::c_int;
    #[c2rust::src_loc = "54:9"]
    pub const NLM_F_REQUEST: libc::c_int = 0x1 as libc::c_int;
    #[c2rust::src_loc = "222:9"]
    pub const NLA_F_NESTED: libc::c_int =
        (1 as libc::c_int) << 15 as libc::c_int;
    #[c2rust::src_loc = "223:9"]
    pub const NLA_F_NET_BYTEORDER: libc::c_int =
...
pub mod bits_in_h {
    ...
    pub const SOL_IP: libc::c_int = 0 as libc::c_int;
}
...
pub use self::sys_socket_h::{__CONST_SOCKADDR_ARG, sockaddr_x25, sockaddr_ns,
                             ...
                             sockaddr_at, socket, bind, sendto, getsockopt,
                             setsockopt};
...
pub use self::in_h::{sockaddr_in6, in6_addr, C2RustUnnamed, in_port_t,
                     ...
                     IPPROTO_ICMP, IPPROTO_IP, IPPROTO_RAW_0};
pub use self::stdint_uintn_h::{uint32_t, uint16_t, uint8_t};
pub use self::dnsmasq_h::{u32_0, all_addr, C2RustUnnamed_1, C2RustUnnamed_2,
                          blockdata, C2RustUnnamed_3, C2RustUnnamed_4,
                          C2RustUnnamed_5, C2RustUnnamed_6, crec,
                          C2RustUnnamed_7, bigname, bogus_addr, doctor,
                          ...
                          dhcp_relay, dnsmasq_daemon, F_IPV6, EC_MISC,
                          safe_malloc, retry_send, die, my_syslog};
pub use self::stat_h::{stat, stat64, _STAT_VER_LINUX, _STAT_VER};
pub use self::int_ll64_h::{__u8, __u16, __u32};
pub use self::linux_types_h::__be16;
pub use self::struct_FILE_h::{_IO_FILE, _IO_lock_t, _IO_EOF_SEEN,
                              _IO_ERR_SEEN, _IO_wide_data, _IO_codecvt,
                              _IO_marker};
pub use self::FILE_h::FILE;
pub use self::stdlib_h::{__compar_fn_t, atol, atoll, atoi, strtol, strtod,
                         strtoll};
...
pub use self::netlink_h::{sockaddr_nl, nlmsghdr, NETLINK_NETFILTER,
                          NLM_F_REQUEST, NLA_F_NESTED, NLA_F_NET_BYTEORDER};
...
pub use self::sys_stat_h::{stat, fstat, stat64, fstat64, fstatat, fstatat64,
                           ...
                           __xmknod, __xmknodat};
use self::string_h::{memcpy, memset, strcpy, strlen, strerror};
pub use self::errno_h::{EAFNOSUPPORT, ENAMETOOLONG};
pub use self::bits_in_h::SOL_IP;
pub use self::dns_protocol_h::{IN6ADDRSZ, INADDRSZ};
pub use self::syslog_h::LOG_ERR;
pub use self::include_errno_h::{errno, __errno_location};
...
#[c2rust::src_loc = "31:9"]
pub const NFNL_SUBSYS_IPSET: libc::c_int = 6 as libc::c_int;
#[c2rust::src_loc = "33:9"]
pub const IPSET_ATTR_DATA: libc::c_int = 7 as libc::c_int;
#[c2rust::src_loc = "34:9"]
pub const IPSET_ATTR_IP: libc::c_int = 1 as libc::c_int;
#[c2rust::src_loc = "35:9"]
pub const IPSET_ATTR_IPADDR_IPV4: libc::c_int = 1 as libc::c_int;
#[c2rust::src_loc = "36:9"]
pub const IPSET_ATTR_IPADDR_IPV6: libc::c_int = 2 as libc::c_int;
#[c2rust::src_loc = "37:9"]
pub const IPSET_ATTR_PROTOCOL: libc::c_int = 1 as libc::c_int;
#[c2rust::src_loc = "38:9"]
pub const IPSET_ATTR_SETNAME: libc::c_int = 2 as libc::c_int;
#[c2rust::src_loc = "39:9"]
pub const IPSET_CMD_ADD: libc::c_int = 9 as libc::c_int;
#[c2rust::src_loc = "40:9"]
pub const IPSET_CMD_DEL: libc::c_int = 10 as libc::c_int;
#[c2rust::src_loc = "41:9"]
pub const IPSET_MAXNAMELEN: libc::c_int = 32 as libc::c_int;
#[c2rust::src_loc = "42:9"]
pub const IPSET_PROTOCOL: libc::c_int = 6 as libc::c_int;
#[c2rust::src_loc = "45:9"]
pub const NFNETLINK_V0: libc::c_int = 0 as libc::c_int;
/* resource id */
/* data structure size in here is fixed */
#[c2rust::src_loc = "69:9"]
pub const BUFF_SZ: libc::c_int = 256 as libc::c_int;
#[c2rust::src_loc = "72:33"]
static mut snl: sockaddr_nl =
    {
        let mut init =
            sockaddr_nl{nl_family: AF_NETLINK as __kernel_sa_family_t,
                        nl_pad: 0,
                        nl_pid: 0,
                        nl_groups: 0,};
        init
...
pub unsafe extern "C" fn ipset_init() {
    ...
    if old_kernel != 0 &&
           {
               ipset_sock = socket(AF_INET, SOCK_RAW_0, IPPROTO_RAW_0);
    ...
    if old_kernel == 0 &&
           {
               buffer = safe_malloc(BUFF_SZ as size_t) as *mut libc::c_char;
               !buffer.is_null()
           } &&
           {
               ipset_sock = socket(AF_NETLINK, SOCK_RAW_0, NETLINK_NETFILTER);
               (ipset_sock) != -(1 as libc::c_int)
           } &&
           bind(ipset_sock,
...
unsafe extern "C" fn new_add_to_ipset(mut setname: *const libc::c_char,
 ...
 -> libc::c_int {
    let mut nlh = 0 as *mut nlmsghdr;
    let mut nfg = 0 as *mut my_nfgenmsg;
    let mut nested: [*mut my_nlattr; 2] = [0 as *mut my_nlattr; 2];
    let mut proto: uint8_t = 0;
    let mut addrsz = if af == AF_INET6 { IN6ADDRSZ } else { INADDRSZ };
    if strlen(setname) >= IPSET_MAXNAMELEN as libc::c_ulong {
        errno = ENAMETOOLONG;
        return -(1 as libc::c_int)
    }
    memset(buffer as *mut libc::c_void, 0 as libc::c_int,
           BUFF_SZ as libc::c_ulong);
    ...
    (*nlh).nlmsg_type =
        ((if remove != 0 { IPSET_CMD_DEL } else { IPSET_CMD_ADD }) |
             NFNL_SUBSYS_IPSET << 8 as libc::c_int) as __u16;
    (*nlh).nlmsg_flags = NLM_F_REQUEST as __u16;
    ...
    (*nfg).version = NFNETLINK_V0 as __u8;
    (*nfg).res_id = __bswap_16(0 as libc::c_int as __uint16_t);
    proto = IPSET_PROTOCOL as uint8_t;
    add_attr(nlh, IPSET_ATTR_PROTOCOL as uint16_t,
             ::std::mem::size_of::<uint8_t>() as libc::c_ulong,
             &mut proto as *mut uint8_t as *const libc::c_void);
    add_attr(nlh, IPSET_ATTR_SETNAME as uint16_t,
    ...
    (*nested[0 as libc::c_int as usize]).nla_type =
        (NLA_F_NESTED | IPSET_ATTR_DATA) as __u16;
    ...
    (*nested[1 as libc::c_int as usize]).nla_type =
        (NLA_F_NESTED | IPSET_ATTR_IP) as __u16;
    add_attr(nlh,
             ((if af == AF_INET {
                   IPSET_ATTR_IPADDR_IPV4
               } else { IPSET_ATTR_IPADDR_IPV6 }) | NLA_F_NET_BYTEORDER) as
                 uint16_t, addrsz as size_t, ipaddr as *const libc::c_void);
    ...
    return if errno == 0 as libc::c_int {
               0 as libc::c_int
 ...
 -> libc::c_int {
    ...
    let mut req_adt_get =
        ip_set_req_adt_get{op: 0,
                           ...
                           typename: [0; 32],};
    let mut req_adt = ip_set_req_adt{op: 0, index: 0, ip: 0,};
    if strlen(setname) >=
    ...
    size =
        ::std::mem::size_of::<ip_set_req_adt_get>() as libc::c_ulong as
            socklen_t;
    if getsockopt(ipset_sock, SOL_IP, 83 as libc::c_int,
    ...
    if setsockopt(ipset_sock, SOL_IP, 83 as libc::c_int,
...
pub unsafe extern "C" fn add_to_ipset(mut setname: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    let mut af = AF_INET;
    if flags as libc::c_uint & F_IPV6 != 0 {
        af = AF_INET6;
        /* old method only supports IPv4 */
        if old_kernel != 0 { errno = EAFNOSUPPORT; ret = -(1 as libc::c_int) }
    }
    ...
    if ret == -(1 as libc::c_int) {
        my_syslog(LOG_ERR,
                  b"failed to update ipset %s: %s\x00" as *const u8 as
                      *const libc::c_char, setname, strerror(errno));
    }
    return ret;
}
