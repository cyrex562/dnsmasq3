...
pub use self::dnsmasq_h::{u16_0, u32_0, all_addr, C2RustUnnamed_0,
                          ...
                          dhcp_relay, dnsmasq_daemon, expand_buf};
...
pub use self::uintn_identity_h::{__uint16_identity, __uint32_identity,
                                 __uint64_identity};
use self::stdio_h::{__getdelim, stdin, stdout, vfprintf, getc, __uflow, putc,
                    __overflow};
...
pub use self::bits_stdio_h::{vprintf, getchar, getc_unlocked,
                             ...
                             feof_unlocked, ferror_unlocked, getline};
...
pub unsafe extern "C" fn end_opt6(mut container: libc::c_int) {
    ...
    let mut len =
        outpacket_counter.wrapping_sub(container as
            ...
            as u16_0;
    let mut t_s = len;
    let mut t_cp = p as *mut libc::c_uchar;
    let fresh6 = t_cp;
    t_cp = t_cp.offset(1);
...
pub unsafe extern "C" fn save_counter(mut newval: libc::c_int)
 -> libc::c_int {
    let mut ret = outpacket_counter as libc::c_int;
...
pub unsafe extern "C" fn new_opt6(mut opt: libc::c_int) -> libc::c_int {
    ...
    if !p.is_null() {
        ...
        *t_cp = t_s as libc::c_uchar;
        p = p.offset(2 as libc::c_int as isize);
        let mut t_s_0 = 0 as libc::c_int as u16_0;
        let mut t_cp_0 = p as *mut libc::c_uchar;
        let fresh8 = t_cp_0;
