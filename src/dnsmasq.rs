...
use defines::{
    C2RustUnnamed_12, __sighandler_t, __sigset_t, cap_user_header_t, gid_t, uid_t, DhcpContext,
...
use crate::defines::{
    AllAddr, C2RustUnnamed_14, C2RustUnnamed_16, C2RustUnnamed_17, C2RustUnnamed_26,
    C2RustUnnamed_27, IcmpHdr, InAddr, InAddrT, IpHdr, Irec, Listener, SaFamily, SockAddr,
    TftpTransfer, __user_cap_data_struct, __user_cap_header_struct, event_desc, sigaction,
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    if cfg!(target = "linux") {
        ...
        sigact.__sigaction_handler.sa_handler = ::std::mem::transmute::<
            libc::intptr_t,
            __sighandler_t,
        >(1 as libc::c_int as libc::intptr_t); /* known umask, create leases and pid files as 0644 */
        libc::sigaction(
            SIGPIPE as libc::c_int,
            &mut sigact,
    ...
    daemon.packet_buff_sz =
        daemon.edns_pktsz as libc::c_int + 1025 as libc::c_int + 10 as libc::c_int;
    // daemon.packet =
    ...
    if daemon.options[(51 as libc::c_int as libc::c_ulong).wrapping_div(
    ...
    //           -(1 as libc::c_int));
    if daemon.options[(45 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
    ...
    if daemon.options[(35 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
    ...
    if daemon.options[(58 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
    ...
    if daemon.options[(13 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
        ...
        != 0
        && daemon.options[(39 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
            ...
            != 0
    {
        ...
        if daemon.options[(39 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
    ...
    if (daemon.port != 0 || daemon.dhcp_enabled || daemon.dhcp6_enabled)
        && (daemon.options[(8 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
            ...
            || daemon.use_dynamic_dirs)
    {
        ...
        daemon.inotifyfd = -(1 as libc::c_int)
    }
    if !daemon.dump_file.is_null() {
        dump_init();
    } else {
        daemon.dumpfd = -(1 as libc::c_int)
    }
    if daemon.options[(19 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
    ...
    if (is_dad_listeners() != 0
        || daemon.options[(39 as libc::c_int as libc::c_ulong).wrapping_div(
            ...
            != 0)
        && (daemon.options[(40 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
            ...
            != 0
            || daemon.port != 0 as libc::c_int && daemon.port <= 1024 as libc::c_int)
    {
    ...
    call safe_malloc */
    let mut capsize: libc::c_int = 1 as libc::c_int; /* for header version 1 */
    ...
    if need_cap_net_admin != 0 {
        (*data).effective |= ((1 as libc::c_int) << 12 as libc::c_int) as libc::c_uint
    }
    if need_cap_net_raw != 0 {
        (*data).effective |= ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint
    }
    if need_cap_net_bind_service != 0 {
        (*data).effective |= ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint
    }
    ...
    if daemon.options[(6 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
        ...
        == 0
    {
        ...
        if daemon.options[(16 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
            ...
            == 0
        {
            ...
            if pid_0 != 0 as libc::c_int {
                let mut ev: event_desc = event_desc {
                    event: 0,
                    data: 0,
                    msg_sz: 0,
                };
            ...
            */
            ...
            if fd == -(1 as libc::c_int) {
                ...
                if read_write(
                    ...
                    strlen(daemon.namebuff) as libc::c_int,
                    0 as libc::c_int,
                ) == 0
                {
                    err = 1 as libc::c_int
    ...
    if (!daemon.dhcp.is_null()
        ...
        || daemon.options[(40 as libc::c_int as libc::c_ulong).wrapping_div(
            ...
            != 0
        || daemon.options[(53 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
        ...
        && getuid() == 0 as libc::c_int as libc::c_uint
    {
        ...
        if !ent_pw.is_null() && (*ent_pw).pw_uid != 0 as libc::c_int as libc::c_uint {
            ...
            (*data).effective |= ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
            (*data).permitted |= ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
    ...
    if daemon.options[(40 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
        ...
        != 0
    {
        ...
        if !daemon.tftp_prefix.is_null() {
            ...
            if dir.is_null() {
                ...
                if daemon.options[(52 as libc::c_int as libc::c_ulong).wrapping_div(
                    (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                        .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                ) as usize]
                    & (1 as libc::c_uint)
    ...
    if daemon.port == 0 as libc::c_int {
        ...
        if daemon.options[(49 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
    ...
    } else if daemon.options[(39 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
    ...
    while !context.is_null() {
        dhcp_context_to_string(2 as libc::c_int, context);
    ...
    if daemon.options[(37 as libc::c_int as libc::c_ulong).wrapping_div(
        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ) as usize]
        & (1 as libc::c_uint)
    ...
    {
        my_syslog(
            (3 as libc::c_int) << 3 as libc::c_int | 6 as libc::c_int,
    ...
    if !netlink_warn.is_null() {
        my_syslog(4 as libc::c_int, netlink_warn);
    }
        ...
        != 0
    {
        ...
        my_syslog(
            ...
            if daemon.options[(26 as libc::c_int as libc::c_ulong).wrapping_div(
                (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
            ) as usize]
                & (1 as libc::c_uint)
            ...
            if daemon.options[(60 as libc::c_int as libc::c_ulong).wrapping_div(
                (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
            ) as usize]
                & (1 as libc::c_uint)
        ...
        if max_fd < 0 as libc::c_int as libc::c_long {
            ...
            && daemon.options[(60 as libc::c_int as libc::c_ulong).wrapping_div(
                (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
            ) as usize]
                & (1 as libc::c_uint)
        ...
        if daemon.start_tftp_port != 0 as libc::c_int
            && ((daemon.end_tftp_port - daemon.start_tftp_port + 1 as libc::c_int) as libc::c_long)
                < max_fd
        {
            max_fd =
                (daemon.end_tftp_port - daemon.start_tftp_port + 1 as libc::c_int) as libc::c_long
    ...
    loop {
        ...
        if !daemon.tftp_trans.is_null()
            || daemon.options[(19 as libc::c_int as libc::c_ulong).wrapping_div(
                (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
            ) as usize]
                & (1 as libc::c_uint)
        ...
        if !daemon.dhcp.is_null() || !daemon.relay4.is_null() {
            poll_listen(daemon.dhcpfd, 0x1 as libc::c_int as libc::c_short);
            if daemon.pxefd != -(1 as libc::c_int) {
                poll_listen(daemon.pxefd, 0x1 as libc::c_int as libc::c_short);
            }
        }
        if daemon.dhcp6_enabled != 0 || !daemon.relay6.is_null() {
            poll_listen(daemon.dhcp6fd, 0x1 as libc::c_int as libc::c_short);
        }
        if daemon.ra_enabled != 0 {
            poll_listen(daemon.icmp6fd, 0x1 as libc::c_int as libc::c_short);
        }
        if daemon.inotifyfd != -(1 as libc::c_int) {
            poll_listen(daemon.inotifyfd, 0x1 as libc::c_int as libc::c_short);
        }
        poll_listen(daemon.netlinkfd, 0x1 as libc::c_int as libc::c_short);
        poll_listen(piperead, 0x1 as libc::c_int as libc::c_short);
        while helper_buf_empty() != 0 && do_script_run(now) != 0 {}
        /* Wake every second whilst waiting for DAD to complete */
        /* Refresh cache */
        if daemon.options[(53 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
        ...
        if helper_buf_empty() == 0 {
            poll_listen(daemon.helperfd, 0x4 as libc::c_int as libc::c_short);
        }
        ...
        if poll_check(daemon.netlinkfd, 0x1 as libc::c_int as libc::c_short) != 0 {
            netlink_multicast();
        }
        if daemon.inotifyfd != -(1 as libc::c_int)
            && poll_check(daemon.inotifyfd, 0x1 as libc::c_int as libc::c_short) != 0
            && inotify_check(now) != 0
        {
            if daemon.port != 0 as libc::c_int
                && daemon.options[(5 as libc::c_int as libc::c_ulong).wrapping_div(
                    (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                        .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                ) as usize]
                    & (1 as libc::c_uint)
        ...
        if !daemon.dhcp.is_null() || !daemon.relay4.is_null() {
            if poll_check(daemon.dhcpfd, 0x1 as libc::c_int as libc::c_short) != 0 {
                dhcp_packet(now, 0 as libc::c_int);
            }
            if daemon.pxefd != -(1 as libc::c_int)
                && poll_check(daemon.pxefd, 0x1 as libc::c_int as libc::c_short) != 0
            {
                dhcp_packet(now, 1 as libc::c_int);
            }
        }
        if (daemon.dhcp6_enabled != 0 || !daemon.relay6.is_null())
            && poll_check(daemon.dhcp6fd, 0x1 as libc::c_int as libc::c_short) != 0
        {
            dhcp6_packet(now);
        }
        if daemon.ra_enabled != 0
            && poll_check(daemon.icmp6fd, 0x1 as libc::c_int as libc::c_short) != 0
        {
            icmp6_packet(now);
        }
        if daemon.helperfd != -(1 as libc::c_int)
            && poll_check(daemon.helperfd, 0x4 as libc::c_int as libc::c_short) != 0
        {
            helper_write();
        }
    }
    ...
    if read_event(pipe_0, &mut ev, &mut msg) != 0 {
        ...
        match ev.event {
            ...
            5 => {
                ...
                /* See Stevens 5.10 */
                {
                    p = waitpid(-(1 as libc::c_int), 0 as *mut libc::c_int, 1 as libc::c_int);
                    ...
                    if p == -(1 as libc::c_int) {
                        ...
                        while i < 20 as libc::c_int {
                            if daemon.tcp_pids[i as usize] == p {
                                daemon.tcp_pids[i as usize] = 0 as libc::c_int
                            }
                            i += 1
                        }
                    }
            ...
            4 => {
                ...
                while i < 20 as libc::c_int {
                    if daemon.tcp_pids[i as usize] != 0 as libc::c_int {
                        kill(daemon.tcp_pids[i as usize], 14 as libc::c_int);
                    }
                    i += 1
                }
...
unsafe extern "C" fn poll_resolv(
    ...
    if !latest.is_null() {
        ...
        if reload_servers((*latest).name) != 0 {
            ...
            check_servers();
            if daemon.options[(24 as libc::c_int as libc::c_ulong).wrapping_div(
                (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
            ) as usize]
                & (1 as libc::c_uint)
...
pub unsafe extern "C" fn clear_cache_and_reload(mut now: time_t) {
    ...
    if !daemon.dhcp.is_null() || daemon.doing_dhcp6 != 0 {
        if daemon.options[(14 as libc::c_int as libc::c_ulong).wrapping_div(
            (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
            & (1 as libc::c_uint)
...
unsafe extern "C" fn set_dns_listeners(mut now: time_t) -> libc::c_int {
        ...
        == 0
    {
        ...
        while !transfer.is_null() {
            tftp += 1;
            poll_listen((*transfer).sockfd, 0x1 as libc::c_int as libc::c_short);
    ...
    if daemon.port != 0 as libc::c_int && daemon.osport == 0 {
        i = 0 as libc::c_int;
        while i < 64 as libc::c_int {
            if daemon.randomsocks[i as usize].refcount as libc::c_int != 0 as libc::c_int {
                poll_listen(
    ...
    while !listener.is_null() {
        ...
        if (*listener).tcpfd != -(1 as libc::c_int) {
            ...
            while i < 20 as libc::c_int {
                if daemon.tcp_pids[i as usize] == 0 as libc::c_int
                    && daemon.tcp_pipes[i as usize] == -(1 as libc::c_int)
                {
                    poll_listen((*listener).tcpfd, 0x1 as libc::c_int as libc::c_short);
                    break;
                } else {
                    i += 1
                }
        ...
        if tftp <= daemon.tftp_max && (*listener).tftpfd != -(1 as libc::c_int) {
            poll_listen((*listener).tftpfd, 0x1 as libc::c_int as libc::c_short);
        }
...
unsafe extern "C" fn check_dns_listeners(mut now: time_t) {
    ...
    serverfdp = daemon.sfds;
    while !serverfdp.is_null() {
        if poll_check((*serverfdp).fd, 0x1 as libc::c_int as libc::c_short) != 0 {
            reply_query(
                (*serverfdp).fd,
    ...
    if daemon.port != 0 as libc::c_int && daemon.osport == 0 {
        ...
        while i < 64 as libc::c_int {
                ...
                ) != 0
            {
                reply_query(
                    daemon.randomsocks[i as usize].fd,
                    daemon.randomsocks[i as usize].family as libc::c_int,
                    now,
                );
            }
            i += 1
        ...
        == 0
    {
        ...
        while i < 20 as libc::c_int {
            if daemon.tcp_pipes[i as usize] != -(1 as libc::c_int)
                && poll_check(
                    daemon.tcp_pipes[i as usize],
                    (0x1 as libc::c_int | 0x10 as libc::c_int) as libc::c_short,
                ) != 0
    ...
    while !listener.is_null() {
        if (*listener).fd != -(1 as libc::c_int)
            && poll_check((*listener).fd, 0x1 as libc::c_int as libc::c_short) != 0
        {
            receive_query(listener, now);
        }
        if (*listener).tftpfd != -(1 as libc::c_int)
            && poll_check((*listener).tftpfd, 0x1 as libc::c_int as libc::c_short) != 0
        {
            tftp_request(listener, now);
        }
        if (*listener).tcpfd != -(1 as libc::c_int)
            && poll_check((*listener).tcpfd, 0x1 as libc::c_int as libc::c_short) != 0
        {
            ...
            loop {
                ...
                if !(confd == -(1 as libc::c_int) && *__errno_location() == 4 as libc::c_int) {
                    break;
                }
            }
                    ...
                    */
                        ...
                        != 0
                    {
                            ...
                            && indextoname((*listener).tcpfd, if_index, intr_name.as_mut_ptr()) != 0
                        {
                            ...
                            if tcp_addr.sa.sa_family as libc::c_int == 10 as libc::c_int {
                    ...
                    if client_ok == 0 {
                        ...
                        close(confd);
                    } else if daemon.options[(6 as libc::c_int as libc::c_ulong).wrapping_div(
                        (::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                    ) as usize]
                        & (1 as libc::c_uint)
                        ...
                        }
                    {
                        ...
                        if p == -(1 as libc::c_int) {
                            ...
                            while i_0 < 20 as libc::c_int {
                                if daemon.tcp_pids[i_0 as usize] == 0 as libc::c_int
                                    && daemon.tcp_pipes[i_0 as usize] == -(1 as libc::c_int)
                                {
                            ...
                            == 0
                        {
                            ...
                            let mut a_0: libc::c_uchar = 0 as libc::c_int as libc::c_uchar; /* close read end in child. */
                            ...
                            close(pipefd[0 as libc::c_int as usize]);
                            daemon.pipe_to_parent = pipefd[1 as libc::c_int as usize]
                        }
                        ...
                        Reset that here. */
                        flags = fcntl(confd, 3 as libc::c_int, 0 as libc::c_int);
                        if flags != -(1 as libc::c_int) {
                            fcntl(confd, 4 as libc::c_int, flags & !(0o4000 as libc::c_int));
                        }
                        ...
                        while !s.is_null() {
                            if (*s).tcpfd != -(1 as libc::c_int) {
                                shutdown((*s).tcpfd, SHUT_RDWR as libc::c_int);
                                close((*s).tcpfd);
                            }
                            s = (*s).next
                        }
...
pub unsafe extern "C" fn icmp_ping(mut addr: InAddr) -> libc::c_int {
    ...
    let mut packet: C2RustUnnamed_27 = C2RustUnnamed_27 {
        ip: IpHdr {
            ip_hl_ip_v: [0; 1],
            ip_tos: 0,
            ip_len: 0,
    ...
    {
        j = j.wrapping_add(
            *(&mut packet.icmp as *mut IcmpHdr as *mut u16).offset(i as isize) as libc::c_uint,
        );
        i = i.wrapping_add(1)
    }
    ...
    {}
    gotreply = delay_dhcp(dnsmasq_time(), 3 as libc::c_int, fd, addr.s_addr, id);
    close(fd);
    return gotreply;
}
#[no_mangle]
pub unsafe extern "C" fn delay_dhcp(
        ...
        && timeout_count < sec * 4 as libc::c_int
    {
        ...
        check_tftp_listeners(now);
        if fd != -(1 as libc::c_int) {
            let mut packet: C2RustUnnamed_26 = C2RustUnnamed_26 {
                ip: IpHdr {
                    ip_hl_ip_v: [0; 1],
                    ip_tos: 0,
                    ip_len: 0,
