...
static struct {
  ...
  { 'Z', OPT_ETHERS, NULL, gettext_noop("Read DHCP static host information from {}."), ETHERSFILE },
...
#  if !defined(HAVE_SCRIPT)
      ret_err(format!("recompile with HAVE_SCRIPT defined to enable lease-change scripts"));
#  else
