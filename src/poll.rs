...
#[c2rust::header_src = "/usr/include/x86_64-linux-gnu/sys/poll.h:17"]
pub mod poll_h {
    #[c2rust::src_loc = "33:1"]
...
pub use self::poll_h::{nfds_t, pollfd, poll};
...
pub use self::inttypes_h::{__gwchar_t, wcstoimax, strtoimax, strtoumax,
...
pub use self::ctype_h::{tolower, toupper, __ctype_tolower_loc,
                        __ctype_toupper_loc};
use self::dnsmasq_h::whine_malloc;
...
*/
#[c2rust::src_loc = "42:23"]
static mut pollfds: *mut pollfd = NULL_0 as *mut pollfd;
