...
pub mod dnsmasq_h {
    ...
    #[c2rust::src_loc = "466:9"]
    pub const F_NAMEP: libc::c_uint = (1 as libc::c_uint) << 1 as libc::c_int;
    #[c2rust::src_loc = "474:9"]
    pub const F_BIGNAME: libc::c_uint =
    ...
    #[c2rust::src_loc = "497:9"]
    pub const UID_NONE: libc::c_int = 0 as libc::c_int;
    #[c2rust::src_loc = "492:9"]
    pub const F_NOEXTRA: libc::c_uint =
        (1 as libc::c_uint) << 27 as libc::c_int;
    #[c2rust::src_loc = "491:9"]
    pub const F_IPSET: libc::c_uint =
        (1 as libc::c_uint) << 26 as libc::c_int;
    #[c2rust::src_loc = "487:9"]
    pub const F_DNSSEC: libc::c_uint =
    ...
    #[c2rust::src_loc = "489:9"]
    pub const F_SECSTAT: libc::c_uint =
    ...
    #[c2rust::src_loc = "488:9"]
    pub const F_KEYTAG: libc::c_uint =
        (1 as libc::c_uint) << 23 as libc::c_int;
    #[c2rust::src_loc = "500:9"]
    pub const SRC_HOSTS: libc::c_int = 2 as libc::c_int;
    #[c2rust::src_loc = "499:9"]
    pub const SRC_CONFIG: libc::c_int = 1 as libc::c_int;
    #[c2rust::src_loc = "468:9"]
    pub const F_FORWARD: libc::c_uint =
        (1 as libc::c_uint) << 3 as libc::c_int;
    #[c2rust::src_loc = "479:9"]
    pub const F_DS: libc::c_uint = (1 as libc::c_uint) << 14 as libc::c_int;
    #[c2rust::src_loc = "477:9"]
    pub const F_DNSKEY: libc::c_uint =
    ...
    #[c2rust::src_loc = "529:9"]
    pub const SERV_COUNTED: libc::c_int = 512 as libc::c_int;
    ...
    pub const TXT_STAT_SERVERS: libc::c_int = 7;
    #[c2rust::src_loc = "358:9"]
    pub const TXT_STAT_AUTH: libc::c_int = 6;
    #[c2rust::src_loc = "357:9"]
    pub const TXT_STAT_HITS: libc::c_int = 5;
    #[c2rust::src_loc = "356:9"]
    pub const TXT_STAT_MISSES: libc::c_int = 4;
    #[c2rust::src_loc = "355:9"]
    pub const TXT_STAT_EVICTIONS: libc::c_int = 3;
    #[c2rust::src_loc = "354:9"]
    pub const TXT_STAT_INSERTS: libc::c_int = 2;
    #[c2rust::src_loc = "353:9"]
    pub const TXT_STAT_CACHESIZE: libc::c_int = 1;
    ...
    extern "C" {
        ...
        pub fn blockdata_free(blocks: *mut blockdata);
        #[no_mangle]
        ...
        pub fn blockdata_write(block: *mut blockdata, len: size_t,
                               fd: libc::c_int);
        #[no_mangle]
        #[c2rust::src_loc = "1210:1"]
        pub fn blockdata_read(fd: libc::c_int, len: size_t) -> *mut blockdata;
        #[no_mangle]
        ...
        pub fn expand_filelist(list: *mut hostsfile) -> *mut hostsfile;
        #[no_mangle]
...
pub use self::dnsmasq_h::{u32_0, all_addr, C2RustUnnamed_2, C2RustUnnamed_3,
                          ...
                          dhcp_relay, dnsmasq_daemon, F_NAMEP, F_BIGNAME,
                          F_IMMORTAL, F_REVERSE, UID_NONE, F_NOEXTRA, F_IPSET,
                          F_DNSSEC, F_QUERY, F_SERVER, F_AUTH, F_SECSTAT,
                          F_UPSTREAM, F_HOSTS, F_DHCP, F_CONFIG, F_RRNAME,
                          F_SRV, F_CNAME, F_IPV6, F_IPV4, F_NXDOMAIN, F_NEG,
                          ADDRSTRLEN, F_RCODE, F_KEYTAG, SRC_HOSTS,
                          SRC_CONFIG, F_FORWARD, F_DS, F_DNSKEY, F_NO_RR,
                          AH_HOSTS, AH_INACTIVE, HR_6, HR_4, MS_DHCP,
                          F_DNSSECOK, SERV_COUNTED, SERV_NO_REBIND,
                          SERV_USE_RESOLV, SERV_LITERAL_ADDRESS, SERV_NO_ADDR,
                          TXT_STAT_SERVERS, TXT_STAT_AUTH, TXT_STAT_HITS,
                          TXT_STAT_MISSES, TXT_STAT_EVICTIONS,
                          TXT_STAT_INSERTS, TXT_STAT_CACHESIZE, whine_malloc,
                          safe_malloc, my_syslog, prettyprint_addr,
                          hostname_isequal, blockdata_free, read_write,
                          blockdata_write, blockdata_read,
                          set_dynamic_inotify, canonicalise, get_domain6,
                          get_domain, expand_filelist, blockdata_retrieve,
                          sockaddr_isequal, blockdata_report};
...
pub use self::stdio_h::{EOF, stdin, stdout, fclose, fopen, sprintf, vfprintf,
                        snprintf, getc, putc, __uflow, __overflow, __getdelim,
                        ungetc};
...
pub use self::sys_stat_h::{stat, fstat, stat64, fstat64, fstatat, fstatat64,
                           ...
                           __xmknod, __xmknodat};
use self::string_h::{memcpy, memset, memcmp, strcpy, strcat, strchr, strlen,
                     strerror};
...
use self::time_h::{difftime, ctime};
pub use self::errno_h::{errno, __errno_location};
pub use self::syslog_h::{LOG_INFO, LOG_ERR, LOG_WARNING, LOG_DAEMON};
pub use self::dns_protocol_h::{NOTIMP, REFUSED, SERVFAIL, INADDRSZ, IN6ADDRSZ,
                               C_IN, MAXDNAME};
pub use self::config_h::{HOSTSFILE, SMALLDNAME};
...
*/
#[c2rust::src_loc = "19:21"]
static mut cache_head: *mut crec = NULL_0 as *mut crec;
#[c2rust::src_loc = "19:41"]
static mut cache_tail: *mut crec = NULL_0 as *mut crec;
#[c2rust::src_loc = "19:62"]
static mut hash_table: *mut *mut crec = NULL_0 as *mut *mut crec;
#[c2rust::src_loc = "21:21"]
static mut dhcp_spare: *mut crec = NULL_0 as *mut crec;
#[c2rust::src_loc = "23:21"]
static mut new_chain: *mut crec = NULL_0 as *mut crec;
#[c2rust::src_loc = "24:12"]
static mut insert_error: libc::c_int = 0;
#[c2rust::src_loc = "25:23"]
static mut big_free: *mut bigname = NULL_0 as *mut bigname;
...
pub unsafe extern "C" fn next_uid(mut crecp: *mut crec) {
    ...
    if (*crecp).uid == UID_NONE as libc::c_uint {
        uid = uid.wrapping_add(1);
        /* uid == 0 used to indicate CNAME to interface name. */
        if uid == UID_NONE as libc::c_uint { uid = uid.wrapping_add(1) }
        (*crecp).uid = uid
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn cache_init() {
    ...
    if (*dnsmasq_daemon).cachesize > 0 as libc::c_int {
        ...
        while i < (*dnsmasq_daemon).cachesize {
            ...
            (*crecp).uid = UID_NONE as libc::c_uint;
            i += 1;
...
unsafe extern "C" fn rehash(mut size: libc::c_int) {
    let mut new = 0 as *mut *mut crec;
    let mut old = 0 as *mut *mut crec;
    let mut p = 0 as *mut crec;
    let mut tmp = 0 as *mut crec;
    let mut i: libc::c_int = 0;
...
unsafe extern "C" fn hash_bucket(mut name: *mut libc::c_char)
 -> *mut *mut crec {
    ...
    let mut val = 0o17465 as libc::c_int as libc::c_uint;
    let mut mix_tab = typestr.as_ptr() as *const libc::c_uchar;
    loop  {
        let fresh7 = name;
        name = name.offset(1);
...
unsafe extern "C" fn cache_hash(mut crecp: *mut crec) {
    ...
    if (*crecp).flags & F_REVERSE == 0 {
        while !(*up).is_null() && (**up).flags & F_REVERSE != 0 {
            up = &mut (**up).hash_next
        }
        if (*crecp).flags & F_IMMORTAL != 0 {
            while !(*up).is_null() && (**up).flags & F_IMMORTAL == 0 {
                up = &mut (**up).hash_next
            }
        }
    }
...
unsafe extern "C" fn cache_free(mut crecp: *mut crec) {
    ...
    (*crecp).next = NULL_0 as *mut crec;
    cache_tail = crecp;
    /* retrieve big name for further use. */
    if (*crecp).flags & F_BIGNAME != 0 {
...
pub unsafe extern "C" fn cache_get_name(mut crecp: *mut crec)
 -> *mut libc::c_char {
    ...
    } else { if (*crecp).flags & F_NAMEP != 0 { return (*crecp).name.namep } }
...
unsafe extern "C" fn is_outdated_cname_pointer(mut crecp: *mut crec)
 -> libc::c_int {
    if (*crecp).flags & F_CNAME == 0 || (*crecp).addr.cname.is_name_ptr != 0 {
        return 0 as libc::c_int
    }
    /* NB. record may be reused as DS or DNSKEY, where uid is 
     overloaded for something completely different */
    if !(*crecp).addr.cname.target.cache.is_null() &&
           (*(*crecp).addr.cname.target.cache).flags & (F_DNSKEY | F_DS) == 0
           &&
...
unsafe extern "C" fn is_expired(mut now: time_t, mut crecp: *mut crec)
 -> libc::c_int {
    if (*crecp).flags & F_IMMORTAL != 0 { return 0 as libc::c_int }
    ...
    if flags & F_FORWARD != 0 {
        ...
        while !crecp.is_null() {
            if (*crecp).flags & F_FORWARD != 0 &&
                ...
                if flags & (*crecp).flags & (F_IPV4 | F_IPV6 | F_SRV) != 0 ||
                       ((*crecp).flags | flags) & F_CNAME != 0 &&
                           (*crecp).flags & (F_DNSKEY | F_DS) == 0 {
        ...
        let mut i: libc::c_int = 0;
        let mut addrlen =
            if flags & F_IPV6 != 0 { IN6ADDRSZ } else { INADDRSZ };
        i = 0 as libc::c_int;
        while i < hash_size {
            crecp = *hash_table.offset(i as isize);
            up = &mut *hash_table.offset(i as isize) as *mut *mut crec;
            while !crecp.is_null() &&
                      ((*crecp).flags & F_REVERSE != 0 ||
                           (*crecp).flags & F_IMMORTAL == 0) {
                if is_expired(now, crecp) != 0 {
                    *up = (*crecp).hash_next;
                    if (*crecp).flags & (F_HOSTS | F_DHCP | F_CONFIG) == 0 {
                        cache_unlink(crecp);
                ...
                } else if (*crecp).flags & (F_HOSTS | F_DHCP | F_CONFIG) == 0
                              && flags & (*crecp).flags & F_REVERSE != 0 &&
                              flags & (*crecp).flags & (F_IPV4 | F_IPV6) != 0
                              &&
...
pub unsafe extern "C" fn cache_start_insert() {
  ...
  */
    while !new_chain.is_null() {
        let mut tmp = (*new_chain).next;
        cache_free(new_chain);
        new_chain = tmp
    }
    new_chain = NULL_0 as *mut crec;
...
pub unsafe extern "C" fn cache_insert(mut name: *mut libc::c_char,
    ...
    log_query(flags | F_UPSTREAM, name, addr, NULL_0 as *mut libc::c_char);
...
unsafe extern "C" fn really_insert(mut name: *mut libc::c_char,
                                   ...
                                   mut flags: libc::c_uint) -> *mut crec {
    let mut new = 0 as *mut crec;
    let mut target_crec = NULL_0 as *mut crec;
    let mut big_name = NULL_0 as *mut bigname;
    let mut freed_all = (flags & F_REVERSE) as libc::c_int;
    let mut free_avail = 0 as libc::c_int;
    let mut target_uid: libc::c_uint = 0;
    /* if previous insertion failed give up now. */
    if insert_error != 0 { return NULL_0 as *mut crec }
    ...
    if !new.is_null() {
	 ...
	 just drop the insert, but don't error the whole process. */
        if flags & (F_IPV4 | F_IPV6) != 0 && flags & F_FORWARD != 0 &&
               !addr.is_null() {
            if flags & F_IPV4 != 0 && (*new).flags & F_IPV4 != 0 &&
                   (*new).addr.addr4.s_addr == (*addr).addr4.s_addr {
                return new
            } else {
                if flags & F_IPV6 != 0 && (*new).flags & F_IPV6 != 0 &&
                       ({
                            let mut __a =
    ...
    if target_crec.is_null() {
        loop  {
            ...
            if (*new).flags & (F_FORWARD | F_REVERSE) == 0 { break ; }
	 ...
	 insert. Once in this state, all inserts will probably fail. */
            ...
            if freed_all != 0 {
                ...
                cache_scan_free(cache_get_name(new), &mut (*new).addr,
                                ...
                                (*new).flags, NULL_0 as *mut *mut crec,
                ...
                cache_scan_free(NULL_0 as *mut libc::c_char,
                                NULL_0 as *mut all_addr, class, now,
                                0 as libc::c_int as libc::c_uint,
                                NULL_0 as *mut *mut crec,
                                NULL_0 as *mut libc::c_uint);
    ...
    if !name.is_null() &&
           strlen(name) > (SMALLDNAME - 1 as libc::c_int) as libc::c_ulong {
        if !big_free.is_null() {
            big_name = big_free;
            big_free = (*big_free).next
        } else if bignames_left == 0 as libc::c_int &&
                      flags & (F_DS | F_DNSKEY) == 0 ||
                      {
                          big_name =
...
pub unsafe extern "C" fn cache_end_insert() {
        ...
        if is_outdated_cname_pointer(new_chain) != 0 {
	     ...
	     The marshalling process is rather nasty. */
            if (*dnsmasq_daemon).pipe_to_parent != -(1 as libc::c_int) {
                let mut name = cache_get_name(new_chain);
                let mut m = strlen(name) as ssize_t;
                let mut flags = (*new_chain).flags;
                ...
                read_write((*dnsmasq_daemon).pipe_to_parent,
                           ...
                           0 as libc::c_int);
                if flags & (F_IPV4 | F_IPV6 | F_DNSKEY | F_DS | F_SRV) != 0 {
                    read_write((*dnsmasq_daemon).pipe_to_parent,
    ...
    if (*dnsmasq_daemon).pipe_to_parent != -(1 as libc::c_int) {
        let mut m_0 = -(1 as libc::c_int) as ssize_t;
        read_write((*dnsmasq_daemon).pipe_to_parent,
...
pub unsafe extern "C" fn cache_recv_insert(mut now: time_t,
 ...
 -> libc::c_int {
    ...
    let mut crecp = NULL_0 as *mut crec;
    cache_start_insert();
    loop  {
        ...
        *(*dnsmasq_daemon).namebuff.offset(m as isize) =
        ...
        if flags & (F_IPV4 | F_IPV6 | F_DNSKEY | F_DS | F_SRV) != 0 {
            let mut class = C_IN as libc::c_ushort;
            if read_write(fd,
            ...
            if flags & F_SRV != 0 && flags & F_NEG == 0 &&
                   {
                       addr.srv.target =
            ...
            let mut newc =
                really_insert((*dnsmasq_daemon).namebuff,
                              NULL_0 as *mut all_addr, C_IN as libc::c_ushort,
                              now, ttl, flags);
	     ...
	     the order reversal on the new_chain. */
            if !newc.is_null() {
                ...
                if crecp.is_null() {
                    (*newc).addr.cname.target.cache = NULL_0 as *mut crec
                } else {
                    next_uid(crecp);
 ...
 -> libc::c_int {
    ...
    while !crecp.is_null() {
        if is_outdated_cname_pointer(crecp) == 0 &&
               is_expired(now, crecp) == 0 && (*crecp).flags & F_FORWARD != 0
               && (*crecp).flags & F_NXDOMAIN == 0 &&
...
pub unsafe extern "C" fn cache_find_by_name(mut crecp: *mut crec,
 ...
 -> *mut crec {
    let mut ans = 0 as *mut crec;
    let mut no_rr = (prot & F_NO_RR) as libc::c_int;
    prot &= !F_NO_RR;
    if !crecp.is_null() {
        /* iterating */
        ans = (*crecp).next
	 ...
	 also free anything which has expired */
        let mut next = 0 as *mut crec;
        let mut up = 0 as *mut *mut crec;
        let mut insert = NULL_0 as *mut *mut crec;
        let mut chainp: *mut *mut crec = &mut ans;
        let mut ins_flags = 0 as libc::c_int as libc::c_uint;
        up = hash_bucket(name);
        crecp = *up;
        while !crecp.is_null() {
		  ...
		  */
                    if !insert.is_null() &&
                           (*crecp).flags & (F_REVERSE | F_IMMORTAL) ==
                               ins_flags {
                        *up = (*crecp).hash_next;
    ...
    if !ans.is_null() && (*ans).flags & F_FORWARD != 0 &&
           (*ans).flags & prot != 0 &&
...
pub unsafe extern "C" fn cache_find_by_addr(mut crecp: *mut crec,
 ...
 -> *mut crec {
    let mut ans = 0 as *mut crec;
    let mut addrlen = if prot == F_IPV6 { IN6ADDRSZ } else { INADDRSZ };
    if !crecp.is_null() {
        /* iterating */
        ans = (*crecp).next
    } else {
	 ...
	 non-REVERSE one.  */
        ...
        while i < hash_size {
            crecp = *hash_table.offset(i as isize);
            up = &mut *hash_table.offset(i as isize) as *mut *mut crec;
            while !crecp.is_null() && (*crecp).flags & F_REVERSE != 0 {
                if is_expired(now, crecp) == 0 {
    ...
    if !ans.is_null() && (*ans).flags & F_REVERSE != 0 &&
           (*ans).flags & prot != 0 &&
...
unsafe extern "C" fn add_hosts_entry(mut cache: *mut crec,
    ...
    let mut lookup =
        cache_find_by_name(NULL_0 as *mut crec, cache_get_name(cache),
  ...
  */
    if !rhash.is_null() {
        ...
        while !lookup.is_null() {
            if (*lookup).flags & (*cache).flags & (F_IPV4 | F_IPV6) != 0 &&
        ...
        lookup =
            cache_find_by_addr(NULL_0 as *mut crec, addr,
                               0 as libc::c_int as time_t,
                               (*cache).flags & (F_IPV4 | F_IPV6));
        if !lookup.is_null() && (*lookup).flags & F_HOSTS != 0 {
            (*cache).flags &= !F_REVERSE
...
unsafe extern "C" fn eatspace(mut f: *mut FILE) -> libc::c_int {
    ...
    let mut nl = 0 as libc::c_int;
    loop  {
        c = getc(f);
        if c == '#' as i32 {
            while c != '\n' as i32 && c != EOF { c = getc(f) }
        }
        if c == EOF { return 1 as libc::c_int }
...
unsafe extern "C" fn gettok(mut f: *mut FILE, mut token: *mut libc::c_char)
 -> libc::c_int {
    ...
    loop  {
        ...
        if count < MAXDNAME - 1 as libc::c_int {
            let fresh10 = count;
            count = count + 1;
...
pub unsafe extern "C" fn read_hostsfile(mut filename: *mut libc::c_char,
                                        ...
                                        mut hashsz: libc::c_int)
 -> libc::c_int {
    let mut f = fopen(filename, b"r\x00" as *const u8 as *const libc::c_char);
    let mut token = (*dnsmasq_daemon).namebuff;
    let mut domain_suffix = NULL_0 as *mut libc::c_char;
    let mut addr_count = 0 as libc::c_int;
    let mut name_count = cache_size;
    let mut lineno = 1 as libc::c_int;
    ...
    if f.is_null() {
        my_syslog(LOG_ERR,
                  b"failed to load names from %s: %s\x00" as *const u8 as
                      *const libc::c_char, filename, strerror(errno));
        return cache_size
    }
    lineno += eatspace(f);
    loop  {
        ...
        while atnl == 0 as libc::c_int {
            let mut cache = 0 as *mut crec;
            let mut fqdn: libc::c_int = 0;
            let mut nomem: libc::c_int = 0;
            let mut canon = 0 as *mut libc::c_char;
            atnl = gettok(f, token);
            if atnl == -(1 as libc::c_int) { break ; }
                       ...
                       != 0 && !domain_suffix.is_null() && fqdn == 0 &&
                       {
                           cache =
                               whine_malloc((::std::mem::size_of::<crec>() as
                                                 libc::c_ulong).wrapping_sub(SMALLDNAME
                                                                                 as
...
pub unsafe extern "C" fn cache_reload() {
    ...
    let mut i: libc::c_int = 0;
    let mut total_size = (*dnsmasq_daemon).cachesize;
    ...
    while i < hash_size {
        ...
        while !cache.is_null() {
            ...
            tmp = (*cache).hash_next;
            if (*cache).flags & (F_HOSTS | F_CONFIG) != 0 {
                *up = (*cache).hash_next;
                free(cache as *mut libc::c_void);
    ...
    while !hr.is_null() {
        ...
        while !nl.is_null() {
            if (*hr).flags & HR_4 != 0 &&
                ...
                (*cache).flags =
                    F_HOSTS | F_IMMORTAL | F_FORWARD | F_REVERSE | F_IPV4 |
                        F_NAMEP | F_CONFIG;
                add_hosts_entry(cache,
                                &mut (*hr).addr as *mut in_addr as
                                    *mut all_addr, INADDRSZ,
                                SRC_CONFIG as libc::c_uint,
            ...
            if (*hr).flags & HR_6 != 0 &&
                ...
                (*cache).ttd = (*hr).ttl as time_t;
                (*cache).flags =
                    F_HOSTS | F_IMMORTAL | F_FORWARD | F_REVERSE | F_IPV6 |
                        F_NAMEP | F_CONFIG;
                add_hosts_entry(cache,
                                &mut (*hr).addr6 as *mut in6_addr as
                                    *mut all_addr, IN6ADDRSZ,
                                SRC_CONFIG as libc::c_uint,
                                (*dnsmasq_daemon).packet as *mut *mut crec,
                                revhashsz);
            }
    ...
    if (*dnsmasq_daemon).options[(4 as libc::c_int as
        ...
        if (*dnsmasq_daemon).options[(4 as libc::c_int as
               ...
               == 0 {
            total_size =
                read_hostsfile(HOSTSFILE.as_mut_ptr(),
                               SRC_HOSTS as libc::c_uint, total_size,
                               (*dnsmasq_daemon).packet as *mut *mut crec,
                               revhashsz)
        }
...
pub unsafe extern "C" fn a_record_from_hosts(mut name: *mut libc::c_char,
    ...
    loop  {
        crecp = cache_find_by_name(crecp, name, now, F_IPV4);
        if crecp.is_null() { break ; }
        if (*crecp).flags & F_HOSTS != 0 { return (*crecp).addr.addr4 }
    }
...
pub unsafe extern "C" fn cache_add_dhcp_entry(mut host_name:
                                              ...
                                              mut ttd: time_t) {
    let mut crec = NULL_0 as *mut crec;
    let mut fail_crec = NULL_0 as *mut crec;
    let mut flags = F_IPV4;
    let mut in_hosts = 0 as libc::c_int;
    let mut addrlen = ::std::mem::size_of::<in_addr>() as libc::c_ulong;
    if prot == AF_INET6 {
        flags = F_IPV6;
    ...
    loop  {
        ...
        if (*crec).flags & (F_HOSTS | F_CONFIG) != 0 {
            if (*crec).flags & F_CNAME != 0 {
                my_syslog(MS_DHCP | LOG_WARNING,
            ...
            if !((*crec).flags & F_DHCP == 0) { continue ; }
            cache_scan_free(host_name, NULL_0 as *mut all_addr,
    ...
    crec =
        cache_find_by_addr(NULL_0 as *mut crec, host_address,
                           0 as libc::c_int as time_t, flags);
    if !crec.is_null() {
        if (*crec).flags & F_NEG != 0 {
            flags |= F_REVERSE;
            cache_scan_free(NULL_0 as *mut libc::c_char, host_address,
                            C_IN as libc::c_ushort,
                            0 as libc::c_int as time_t, flags,
                            NULL_0 as *mut *mut crec,
                            NULL_0 as *mut libc::c_uint);
    ...
    if !crec.is_null() {
        ...
        (*crec).uid = UID_NONE as libc::c_uint;
        cache_hash(crec);
...
unsafe extern "C" fn make_non_terminals(mut source: *mut crec) {
    let mut name = cache_get_name(source);
    let mut crecp = 0 as *mut crec;
    let mut tmp = 0 as *mut crec;
    let mut up = 0 as *mut *mut crec;
    let mut type_0 = (F_HOSTS | F_CONFIG) as libc::c_int;
    if (*source).flags & F_DHCP != 0 { type_0 = F_DHCP as libc::c_int }
    ...
    while !crecp.is_null() {
        ...
        if is_outdated_cname_pointer(crecp) == 0 &&
               ...
               (*crecp).flags &
                   (F_IPV4 | F_IPV6 | F_CNAME | F_SRV | F_DNSKEY | F_DS) == 0
               && hostname_isequal(name, cache_get_name(crecp)) != 0 {
            *up = (*crecp).hash_next;
            if type_0 as libc::c_uint & F_DHCP != 0 {
    ...
    loop  {
        ...
        if !crecp.is_null() {
	     ...
	     empty non-terminal entry. */
            ...
            if (*source).flags & F_DHCP != 0 && !dhcp_spare.is_null() {
                crecp = dhcp_spare;
                dhcp_spare = (*dhcp_spare).next
            } else {
                crecp =
            ...
            if !crecp.is_null() {
                (*crecp).flags =
                    ((*source).flags | F_NAMEP) &
                        !(F_IPV4 | F_IPV6 | F_CNAME | F_SRV | F_DNSKEY | F_DS
                              | F_REVERSE);
                (*crecp).ttd = (*source).ttd;
...
pub unsafe extern "C" fn cache_make_stat(mut t: *mut txt_record)
 -> libc::c_int {
    static mut buff: *mut libc::c_char = NULL_0 as *mut libc::c_char;
    static mut bufflen: libc::c_int = 60 as libc::c_int;
    let mut len: libc::c_int = 0;
    let mut serv = 0 as *mut server;
    let mut serv1 = 0 as *mut server;
            ...
            while !serv.is_null() {
                if (*serv).flags &
                       (SERV_NO_ADDR | SERV_LITERAL_ADDRESS | SERV_COUNTED |
                            SERV_USE_RESOLV | SERV_NO_REBIND) == 0 {
                    let mut new = 0 as *mut libc::c_char;
                    let mut lenp = 0 as *mut libc::c_char;
                    let mut port: libc::c_int = 0;
                    let mut newlen: libc::c_int = 0;
                    let mut bytes_avail: libc::c_int = 0;
                    let mut bytes_needed: libc::c_int = 0;
                    let mut queries = 0 as libc::c_int as libc::c_uint;
                    let mut failed_queries = 0 as libc::c_int as libc::c_uint;
                    serv1 = serv;
                    while !serv1.is_null() {
                        if (*serv1).flags &
                               (SERV_NO_ADDR | SERV_LITERAL_ADDRESS |
                                    SERV_COUNTED | SERV_USE_RESOLV |
                                    SERV_NO_REBIND) == 0 &&
...
pub unsafe extern "C" fn dump_cache(mut now: time_t) {
    let mut serv = 0 as *mut server;
    let mut serv1 = 0 as *mut server;
    my_syslog(LOG_INFO, b"time %lu\x00" as *const u8 as *const libc::c_char,
              now as libc::c_ulong);
    my_syslog(LOG_INFO,
                ...
                *a = 0 as libc::c_int as libc::c_char;
                ...
                p =
                    p.offset(sprintf(p,
                                 ...
                                 isize);
                if (*cache).flags & F_CNAME != 0 &&
                       is_outdated_cname_pointer(cache) == 0 {
                    a = sanitise(cache_get_cname_target(cache))
                } else if (*cache).flags & F_SRV != 0 &&
                              (*cache).flags & F_NEG == 0 {
                    let mut targetlen =
                    ...
                    *a.offset((len + targetlen as libc::c_long) as isize) =
                        0 as libc::c_int as libc::c_char
                } else if (*cache).flags & F_NEG == 0 ||
                              (*cache).flags & F_FORWARD == 0 {
                    a = (*dnsmasq_daemon).addrbuff;
                    if (*cache).flags & F_IPV4 != 0 {
                        inet_ntop(AF_INET,
                                  &mut (*cache).addr as *mut all_addr as
                                      *const libc::c_void, a,
                                  ADDRSTRLEN as socklen_t);
                    } else if (*cache).flags & F_IPV6 != 0 {
                        inet_ntop(AF_INET6,
                                  &mut (*cache).addr as *mut all_addr as
                                      *const libc::c_void, a,
                                  ADDRSTRLEN as socklen_t);
...
pub unsafe extern "C" fn record_source(mut index: libc::c_uint)
 -> *mut libc::c_char {
    let mut ah = 0 as *mut hostsfile;
    if index == SRC_CONFIG as libc::c_uint {
        return b"config\x00" as *const u8 as *const libc::c_char as
                   *mut libc::c_char
    } else {
        if index == SRC_HOSTS as libc::c_uint {
            return HOSTSFILE.as_mut_ptr()
        }
    }
    ah = (*dnsmasq_daemon).addn_hosts;
    while !ah.is_null() {
...
pub unsafe extern "C" fn querystr(mut desc: *mut libc::c_char,
 ...
 -> *mut libc::c_char {
    ...
    let mut len = 10 as libc::c_int;
    let mut types = NULL_0 as *const libc::c_char;
    static mut buff: *mut libc::c_char = NULL_0 as *mut libc::c_char;
...
pub unsafe extern "C" fn log_query(mut flags: libc::c_uint,
    ...
    if !addr.is_null() {
        if flags & F_KEYTAG != 0 {
            ...
            let mut rcode = (*addr).log.rcode as libc::c_uint;
            if rcode == SERVFAIL as libc::c_uint {
                dest =
                    b"SERVFAIL\x00" as *const u8 as *const libc::c_char as
                        *mut libc::c_char
            } else if rcode == REFUSED as libc::c_uint {
                dest =
                    b"REFUSED\x00" as *const u8 as *const libc::c_char as
                        *mut libc::c_char
            } else if rcode == NOTIMP as libc::c_uint {
                dest =
            ...
            inet_ntop(if flags & F_IPV4 != 0 { AF_INET } else { AF_INET6 },
    ...
    if flags & F_NEG != 0 {
        ...
        dest =
            b"<CNAME>\x00" as *const u8 as *const libc::c_char as
                *mut libc::c_char
    } else if flags & F_SRV != 0 {
        dest =
            b"<SRV>\x00" as *const u8 as *const libc::c_char as
                *mut libc::c_char
    } else if flags & F_RRNAME != 0 { dest = arg }
    if flags & F_CONFIG != 0 {
        source =
