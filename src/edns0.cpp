...
{ 
  unsigned char *lenp, *datap, *p, *udp_len, *buff = nullptr;
  int rdlen = 0, is_sign, is_last;
  unsigned short flags = set_do ? 0x8000 : 0, rcode = 0;

  p = find_pseudoheader(header, plen, nullptr, &udp_len, &is_sign, &is_last);
...
{
  return add_pseudoheader(header, plen, (unsigned char *)limit, PACKETSZ, 0, nullptr, 0, 1, 0);
}
